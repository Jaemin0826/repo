...
`;function r6({ranking:r,user:t}){const i=Bn.useMemo(()=>zE(t??{}),[t]),a=r===1?jE:r===2?qE:r===3?HE:null;return ut.jsxs($I,{$ranking:r,children:[a&&ut.jsx(i6,{$ranking:r,src:a,alt:`Rank${r}`}),ut.jsxs(ZI,{children:[ut.jsx(JI,{$ranking:r,children:(()=>{const l=t&&(t.nickname||t.userName||t.name)||"-";return l.length>6?l.slice(0,6)+"...":l})()}),ut.jsxs(WI,{children:[ut.jsx(t6,{$ranking:r,children:t&&typeof t.distanceKm=="number"?t.distanceKm.toFixed(2):t&&!isNaN(Number(t.distanceKm))?Number(t.distanceKm).toFixed(2):"-"}),ut.jsx(e6,{$ranking:r,children:"km"})]})]}),ut.jsx(n6,{children:i.map(l=>ut.jsx("img",{src:BE(l.key,l.level),alt:`${l.category} Lv.${l.level}`,style:{width:32,height:32}},l.key))})]})}const s6=Ct.div`
  width: 100%;
  max-width: 1024px;
  display: flex;
  justify-content: center;
...
`,S6=Ct.div`
  ...
  line-height: 100%; /* 16px */
  letter-spacing: -0.32px;
`;function A6({ranking:r,user:t,highlight:i,...a}){const l=Bn.useMemo(()=>zE(t??{}),[t]),c=r===1?jE:r===2?qE:r===3?HE:null;return ut.jsxs(p6,{$ranking:r,$highlight:i,...a,children:[ut.jsx(m6,{$ranking:r,children:c?ut.jsx("img",{src:c,alt:`Rank${r}`,style:{width:40,height:40}}):ut.jsx(g6,{children:r})}),ut.jsx(y6,{$ranking:r,children:t&&(t.nickname||t.userName||t.name)||"-"}),ut.jsx(_6,{children:ut.jsx(v6,{children:l.map(d=>ut.jsx("img",{src:BE(d.key,d.level),alt:`${d.category} Lv.${d.level}`,style:{width:28,height:28}},d.key))})}),ut.jsxs(E6,{$ranking:r,children:[ut.jsx(T6,{$ranking:r,children:t&&!isNaN(Number(t.distanceKm))?Number(t.distanceKm).toFixed(2):"-"}),ut.jsx(S6,{$ranking:r,children:"km"})]})]})}const b6=Ct.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 20px;
...
`;function H6(){const[r,t]=Bn.useState([]);return Bn.useEffect(()=>{console.log("Firebase App Name:",Gh.name),(async()=>{try{const l=(await _C(oC(Y4,"userFields"))).docs.map(c=>({id:c.id,...c.data()}));t(l),console.log("userFields 컬렉션 데이터:",l)}catch(a){console.error("userFields 데이터 불러오기 오류:",a)}})()},[]),ut.jsxs(z6,{children:[ut.jsxs(B6,{children:[ut.jsxs(j6,{children:[ut.jsx("img",{src:L6}),ut.jsx("img",{src:k6}),ut.jsx("img",{src:P6}),ut.jsx("p",{children:"Ranking"})]}),ut.jsx(q6,{children:ut.jsx("img",{src:QI,alt:"Ranking Logo"})})]}),ut.jsx(f6,{userFields:r}),ut.jsx(U6,{userFields:r})]})}function F6(){return ut.jsx(ut.Fragment,{children:ut.jsx(H6,{})})}NS.createRoot(document.getElementById("root")).render(ut.jsx(Bn.StrictMode,{children:ut.jsx(F6,{})}));

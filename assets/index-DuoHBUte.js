 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const LS=()=>US().__FIREBASE_DEFAULTS__,kS=()=>{if(typeof process>"u"||typeof v_>"u")return;const r=v_.__FIREBASE_DEFAULTS__;if(r)return JSON.parse(r)},PS=()=>{if(typeof document>"u")return;let r;try{r=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=r&&f2(r[1]);return t&&JSON.parse(t)},Ih=()=>{try{return OS()||LS()||kS()||PS()}catch(r){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${r}`);return}},d2=r=>Ih()?.emulatorHosts?.[r],p2=r=>{const t=d2(r);if(!t)return;const i=t.lastIndexOf(":");if(i<=0||i+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);const a=parseInt(t.substring(i+1),10);return t[0]==="["?[t.substring(1,i-1),a]:[t.substring(0,i),a]},m2=()=>Ih()?.config,g2=r=>Ih()?.[`_${r}`];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZS="FirebaseError";class zi extends Error{constructor(t,i,a){super(i),this.code=t,this.customData=a,this.name=ZS,Object.setPrototypeOf(this,zi.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Wl.prototype.create)}}class Wl{constructor(t,i,a){this.service=t,this.serviceName=i,this.errors=a}create(t,...i){const a=i[0]||{},l=`${this.service}/${t}`,c=this.errors[t],d=c?JS(c,a):"Error",g=`${this.serviceName}: ${d} (${l}).`;return new zi(l,g,a)}}function JS(r,t){return r.replace(WS,(i,a)=>{const l=t[a];return l!=null?String(l):`<${a}?>`})}const WS=/\{\$([^}]+)}/g;function tA(r){for(const t in r)if(Object.prototype.hasOwnProperty.call(r,t))return!1;return!0}function Zs(r,t){if(r===t)return!0;const i=Object.keys(r),a=Object.keys(t);for(const l of i){if(!a.includes(l))return!1;const c=r[l],d=t[l];if(T_(c)&&T_(d)){if(!Zs(c,d))return!1}else if(c!==d)return!1}for(const l of a)if(!i.includes(l))return!1;return!0}function T_(r){return r!==null&&typeof r=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ur=new am("@firebase/app"),wA="@firebase/app-compat",RA="@firebase/analytics-compat",CA="@firebase/analytics",IA="@firebase/app-check-compat",DA="@firebase/app-check",NA="@firebase/auth",OA="@firebase/auth-compat",xA="@firebase/database",MA="@firebase/data-connect",VA="@firebase/database-compat",UA="@firebase/functions",LA="@firebase/functions-compat",kA="@firebase/installations",PA="@firebase/installations-compat",zA="@firebase/messaging",BA="@firebase/messaging-compat",jA="@firebase/performance",qA="@firebase/performance-compat",HA="@firebase/remote-config",FA="@firebase/remote-config-compat",GA="@firebase/storage",KA="@firebase/storage-compat",YA="@firebase/firestore",QA="@firebase/ai",XA="@firebase/firestore-compat",$A="firebase",ZA="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const na=ZA;function E2(r,t={}){let i=r;typeof t!="object"&&(t={name:t});const a={name:wp,automaticDataCollectionEnabled:!0,...t},l=a.name;if(typeof l!="string"||!l)throw es.create("bad-app-name",{appName:String(l)});if(i||(i=m2()),!i)throw es.create("no-options");const c=Fl.get(l);if(c){if(Zs(i,c.options)&&Zs(a,c.config))return c;throw es.create("duplicate-app",{appName:l})}const d=new oA(l);for(const y of Rp.values())d.addComponent(y);const g=new eb(i,a,d);return Fl.set(l,g),g}function Nh(r=wp){const t=Fl.get(r);if(!t&&r===wp&&m2())return E2();if(!t)throw es.create("no-app",{appName:r});return t}function nb(){return Array.from(Fl.values())}function xi(r,t,i){let a=JA[r]??r;i&&(a+=`-${i}`);const l=a.match(/\s|\//),c=t.match(/\s|\//);if(l||c){const d=[`Unable to register library "${a}" with version "${t}":`];l&&d.push(`library name "${a}" contains illegal characters (whitespace or "/")`),l&&c&&d.push("and"),c&&d.push(`version name "${t}" contains illegal characters (whitespace or "/")`),ur.warn(d.join(" "));return}Js(new ss(`${a}-version`,()=>({library:a,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ib="firebase-heartbeat-database",rb=1,Gl="firebase-heartbeat-store";let op=null;function T2(){return op||(op=EA(ib,rb,{upgrade:(r,t)=>{switch(t){case 0:try{r.createObjectStore(Gl)}catch(i){console.warn(i)}}}}).catch(r=>{throw es.create("idb-open",{originalErrorMessage:r.message})})),op}async function sb(r){try{const i=(await T2()).transaction(Gl),a=await i.objectStore(Gl).get(S2(r));return await i.done,a}catch(t){if(t instanceof zi)ur.warn(t.message);else{const i=es.create("idb-get",{originalErrorMessage:t?.message});ur.warn(i.message)}}}async function C_(r,t){try{const a=(await T2()).transaction(Gl,"readwrite");await a.objectStore(Gl).put(t,S2(r)),await a.done}catch(i){if(i instanceof zi)ur.warn(i.message);else{const a=es.create("idb-set",{originalErrorMessage:i?.message});ur.warn(a.message)}}}function S2(r){return`${r.name}!${r.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fb(r){Js(new ss("platform-logger",t=>new AA(t),"PRIVATE")),Js(new ss("heartbeat",t=>new lb(t),"PRIVATE")),xi(bp,w_,r),xi(bp,w_,"esm2020"),xi("fire-js","")}fb("");var db="firebase",pb="12.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bt(r,t,i){let a="Unexpected state";typeof t=="string"?a=t:i=t,D2(r,a,i)}function D2(r,t,i){let a=`FIRESTORE (${To}) INTERNAL ASSERTION FAILED: ${t} (ID: ${r.toString(16)})`;if(i!==void 0)try{a+=" CONTEXT: "+JSON.stringify(i)}catch{a+=" CONTEXT: "+i}throw cr(a),new Error(a)}function ce(r,t,i,a){let l="Unexpected state";typeof i=="string"?l=i:a=i,r||D2(t,l,a)}function Bt(r,t){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kl=-1;function Ib(r,t){const i=r.toTimestamp().seconds,a=r.toTimestamp().nanoseconds+1,l=St.fromTimestamp(a===1e9?new Ne(i+1,0):new Ne(i,a));return new as(l,_t.empty(),t)}function Db(r){return new as(r.readTime,r.key,Kl)}class as{constructor(t,i,a){this.readTime=t,this.documentKey=i,this.largestBatchId=a}static min(){return new as(St.min(),_t.empty(),Kl)}static max(){return new as(St.max(),_t.empty(),Kl)}}function Nb(r,t){let i=r.readTime.compareTo(t.readTime);return i!==0?i:(i=_t.comparator(r.documentKey,t.documentKey),i!==0?i:kt(r.largestBatchId,t.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const x2="";function Ub(r){let t="";for(let i=0;i<r.length;i++)t.length>0&&(t=P_(t)),t=Lb(r.get(i),t);return P_(t)}function Lb(r,t){let i=t;const a=r.length;for(let l=0;l<a;l++){const c=r.charAt(l);switch(c){case"\0":i+="";break;case x2:i+="";break;default:i+=c}}return i}function P_(r){return r+x2+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xe{constructor(t){this.binaryString=t}static fromBase64String(t){const i=(function(l){try{return atob(l)}catch(c){throw typeof DOMException<"u"&&c instanceof DOMException?new M2("Invalid base64 string: "+c):c}})(t);return new Xe(i)}static fromUint8Array(t){const i=(function(l){let c="";for(let d=0;d<l.length;++d)c+=String.fromCharCode(l[d]);return c})(t);return new Xe(i)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(i){return btoa(i)})(this.binaryString)}toUint8Array(){return(function(i){const a=new Uint8Array(i.length);for(let l=0;l<i.length;l++)a[l]=i.charCodeAt(l);return a})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return kt(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}Xe.EMPTY_BYTE_STRING=new Xe("");const Pb=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function os(r){if(ce(!!r,39018),typeof r=="string"){let t=0;const i=Pb.exec(r);if(ce(!!i,46558,{timestamp:r}),i[1]){let l=i[1];l=(l+"000000000").substr(0,9),t=Number(l)}const a=new Date(r);return{seconds:Math.floor(a.getTime()/1e3),nanos:t}}return{seconds:_e(r.seconds),nanos:_e(r.nanos)}}function _e(r){return typeof r=="number"?r:typeof r=="string"?Number(r):0}function ls(r){return typeof r=="string"?Xe.fromBase64String(r):Xe.fromUint8Array(r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V2="server_timestamp",U2="__type__",L2="__previous_value__",k2="__local_write_time__";function um(r){return(r?.mapValue?.fields||{})[U2]?.stringValue===V2}function Vh(r){const t=r.mapValue.fields[L2];return um(t)?Vh(t):t}function Yl(r){const t=os(r.mapValue.fields[k2].timestampValue);return new Ne(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class P2{}class Ue extends P2{constructor(t,i,a){super(),this.field=t,this.op=i,this.value=a}static create(t,i,a){return t.isKeyField()?i==="in"||i==="not-in"?this.createKeyFieldInFilter(t,i,a):new Yb(t,i,a):i==="array-contains"?new $b(t,a):i==="in"?new Zb(t,a):i==="not-in"?new Jb(t,a):i==="array-contains-any"?new Wb(t,a):new Ue(t,i,a)}static createKeyFieldInFilter(t,i,a){return i==="in"?new Qb(t,a):new Xb(t,a)}matches(t){const i=t.data.field(this.field);return this.op==="!="?i!==null&&i.nullValue===void 0&&this.matchesComparison(uo(i,this.value)):i!==null&&us(this.value)===us(i)&&this.matchesComparison(uo(i,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return bt(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class ki extends P2{constructor(t,i){super(),this.filters=t,this.op=i,this.Pe=null}static create(t,i){return new ki(t,i)}matches(t){return z2(this)?this.filters.find((i=>!i.matches(t)))===void 0:this.filters.find((i=>i.matches(t)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((t,i)=>t.concat(i.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function z2(r){return r.op==="and"}function B2(r){return Kb(r)&&z2(r)}function Kb(r){for(const t of r.filters)if(t instanceof ki)return!1;return!0}function Vp(r){if(r instanceof Ue)return r.field.canonicalString()+r.op.toString()+co(r.value);if(B2(r))return r.filters.map((t=>Vp(t))).join(",");{const t=r.filters.map((i=>Vp(i))).join(",");return`${r.op}(${t})`}}function j2(r,t){return r instanceof Ue?(function(a,l){return l instanceof Ue&&a.op===l.op&&a.field.isEqual(l.field)&&Li(a.value,l.value)})(r,t):r instanceof ki?(function(a,l){return l instanceof ki&&a.op===l.op&&a.filters.length===l.filters.length?a.filters.reduce(((c,d,g)=>c&&j2(d,l.filters[g])),!0):!1})(r,t):void bt(19439)}function q2(r){return r instanceof Ue?(function(i){return`${i.field.canonicalString()} ${i.op} ${co(i.value)}`})(r):r instanceof ki?(function(i){return i.op.toString()+" {"+i.getFilters().map(q2).join(" ,")+"}"})(r):"Filter"}class Yb extends Ue{constructor(t,i,a){super(t,i,a),this.key=_t.fromName(a.referenceValue)}matches(t){const i=_t.comparator(t.key,this.key);return this.matchesComparison(i)}}class Qb extends Ue{constructor(t,i){super(t,"in",i),this.keys=H2("in",i)}matches(t){return this.keys.some((i=>i.isEqual(t.key)))}}class Xb extends Ue{constructor(t,i){super(t,"not-in",i),this.keys=H2("not-in",i)}matches(t){return!this.keys.some((i=>i.isEqual(t.key)))}}function H2(r,t){return(t.arrayValue?.values||[]).map((i=>_t.fromName(i.referenceValue)))}class $b extends Ue{constructor(t,i){super(t,"array-contains",i)}matches(t){const i=t.data.field(this.field);return cm(i)&&Xl(i.arrayValue,this.value)}}class Zb extends Ue{constructor(t,i){super(t,"in",i)}matches(t){const i=t.data.field(this.field);return i!==null&&Xl(this.value.arrayValue,i)}}class Jb extends Ue{constructor(t,i){super(t,"not-in",i)}matches(t){if(Xl(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const i=t.data.field(this.field);return i!==null&&i.nullValue===void 0&&!Xl(this.value.arrayValue,i)}}class Wb extends Ue{constructor(t,i){super(t,"array-contains-any",i)}matches(t){const i=t.data.field(this.field);return!(!cm(i)||!i.arrayValue.values)&&i.arrayValue.values.some((a=>Xl(this.value.arrayValue,a)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aw=new ve(_t.comparator);function cs(){return aw}const Y2=new ve(_t.comparator);function Ml(...r){let t=Y2;for(const i of r)t=t.insert(i.key,i);return t}function ow(r){let t=Y2;return r.forEach(((i,a)=>t=t.insert(i,a.overlayedDocument))),t}function Fs(){return zl()}function Q2(){return zl()}function zl(){return new ia((r=>r.toString()),((r,t)=>r.isEqual(t)))}const lw=new Le(_t.comparator);function jt(...r){let t=lw;for(const i of r)t=t.add(i);return t}const uw=new Le(kt);function cw(){return uw}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const r1={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0},uv=41943040;class pn{static withCacheSize(t){return new pn(t,pn.DEFAULT_COLLECTION_PERCENTILE,pn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(t,i,a){this.cacheSizeCollectionThreshold=t,this.percentileToCollect=i,this.maximumSequenceNumbersToCollect=a}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */pn.DEFAULT_COLLECTION_PERCENTILE=10,pn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,pn.DEFAULT=new pn(uv,pn.DEFAULT_COLLECTION_PERCENTILE,pn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),pn.DISABLED=new pn(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ze="WebChannelConnection";class TR extends vR{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,i,a,l,c){const d=qp();return new Promise(((g,y)=>{const v=new b2;v.setWithCredentials(!0),v.listenOnce(w2.COMPLETE,(()=>{try{switch(v.getLastErrorCode()){case Xc.NO_ERROR:const b=v.getResponseJson();st(Ze,`XHR for RPC '${t}' ${d} received:`,JSON.stringify(b)),g(b);break;case Xc.TIMEOUT:st(Ze,`RPC '${t}' ${d} timed out`),y(new pt(W.DEADLINE_EXCEEDED,"Request time out"));break;case Xc.HTTP_ERROR:const x=v.getStatus();if(st(Ze,`RPC '${t}' ${d} failed with status:`,x,"response text:",v.getResponseText()),x>0){let q=v.getResponseJson();Array.isArray(q)&&(q=q[0]);const $=q?.error;if($&&$.status&&$.message){const Z=(function(rt){const ct=rt.toLowerCase().replace(/_/g,"-");return Object.values(W).indexOf(ct)>=0?ct:W.UNKNOWN})($.status);y(new pt(Z,$.message))}else y(new pt(W.UNKNOWN,"Server responded with status "+v.getStatus()))}else y(new pt(W.UNAVAILABLE,"Connection failed."));break;default:bt(9055,{l_:t,streamId:d,h_:v.getLastErrorCode(),P_:v.getLastError()})}}finally{st(Ze,`RPC '${t}' ${d} completed.`)}}));const S=JSON.stringify(l);st(Ze,`RPC '${t}' ${d} sending request:`,l),v.send(i,"POST",S,a,15)}))}T_(t,i,a){const l=qp(),c=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],d=I2(),g=C2(),y={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},v=this.longPollingOptions.timeoutSeconds;v!==void 0&&(y.longPollingTimeout=Math.round(1e3*v)),this.useFetchStreams&&(y.useFetchStreams=!0),this.jo(y.initMessageHeaders,i,a),y.encodeInitMessageHeaders=!0;const S=c.join("");st(Ze,`Creating RPC '${t}' stream ${l}: ${S}`,y);const b=d.createWebChannel(S,y);this.I_(b);let x=!1,q=!1;const $=new ER({Yo:X=>{q?st(Ze,`Not sending because RPC '${t}' stream ${l} is closed:`,X):(x||(st(Ze,`Opening RPC '${t}' stream ${l} transport.`),b.open(),x=!0),st(Ze,`RPC '${t}' stream ${l} sending:`,X),b.send(X))},Zo:()=>b.close()}),Z=(X,rt,ct)=>{X.listen(rt,(nt=>{try{ct(nt)}catch(lt){setTimeout((()=>{throw lt}),0)}}))};return Z(b,xl.EventType.OPEN,(()=>{q||(st(Ze,`RPC '${t}' stream ${l} transport opened.`),$.o_())})),Z(b,xl.EventType.CLOSE,(()=>{q||(q=!0,st(Ze,`RPC '${t}' stream ${l} transport closed`),$.a_(),this.E_(b))})),Z(b,xl.EventType.ERROR,(X=>{q||(q=!0,oo(Ze,`RPC '${t}' stream ${l} transport errored. Name:`,X.name,"Message:",X.message),$.a_(new pt(W.UNAVAILABLE,"The operation could not be completed")))})),Z(b,xl.EventType.MESSAGE,(X=>{if(!q){const rt=X.data[0];ce(!!rt,16349);const ct=rt,nt=ct?.error||ct[0]?.error;if(nt){st(Ze,`RPC '${t}' stream ${l} received error:`,nt);const lt=nt.status;let yt=(function(w){const C=De[w];if(C!==void 0)return tv(C)})(lt),at=nt.message;yt===void 0&&(yt=W.INTERNAL,at="Unknown error status: "+lt+" with message "+nt.message),q=!0,$.a_(new pt(yt,at)),b.close()}else st(Ze,`RPC '${t}' stream ${l} received:`,rt),$.u_(rt)}})),Z(g,R2.STAT_EVENT,(X=>{X.stat===Cp.PROXY?st(Ze,`RPC '${t}' stream ${l} detected buffering proxy`):X.stat===Cp.NOPROXY&&st(Ze,`RPC '${t}' stream ${l} detected no buffering proxy`)})),setTimeout((()=>{$.__()}),0),$}terminate(){this.c_.forEach((t=>t.close())),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter((i=>i===t))}}function fp(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dv(r){return new Iw(r,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fo="RemoteStore";class CR{constructor(t,i,a,l,c){this.localStore=t,this.datastore=i,this.asyncQueue=a,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=c,this.Aa.Oo((d=>{a.enqueueAndForget((async()=>{su(this)&&(st(fo,"Restarting streams for network reachability change."),await(async function(y){const v=Bt(y);v.Ea.add(4),await ru(v),v.Ra.set("Unknown"),v.Ea.delete(4),await jh(v)})(this))}))})),this.Ra=new RR(a,l)}}async function jh(r){if(su(r))for(const t of r.da)await t(!0)}async function ru(r){for(const t of r.da)await t(!1)}function mv(r,t){const i=Bt(r);i.Ia.has(t.targetId)||(i.Ia.set(t.targetId,t),Am(i)?Sm(i):Ao(i).O_()&&Tm(i,t))}function Em(r,t){const i=Bt(r),a=Ao(i);i.Ia.delete(t),a.O_()&&gv(i,t),i.Ia.size===0&&(a.O_()?a.L_():su(i)&&i.Ra.set("Unknown"))}function Tm(r,t){if(r.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(St.min())>0){const i=r.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(i)}Ao(r).Y_(t)}function gv(r,t){r.Va.Ue(t),Ao(r).Z_(t)}function Sm(r){r.Va=new bw({getRemoteKeysForTarget:t=>r.remoteSyncer.getRemoteKeysForTarget(t),At:t=>r.Ia.get(t)||null,ht:()=>r.datastore.serializer.databaseId}),Ao(r).start(),r.Ra.ua()}function Am(r){return su(r)&&!Ao(r).x_()&&r.Ia.size>0}function su(r){return Bt(r).Ea.size===0}function yv(r){r.Va=void 0}async function IR(r){r.Ra.set("Online")}async function DR(r){r.Ia.forEach(((t,i)=>{Tm(r,t)}))}async function NR(r,t){yv(r),Am(r)?(r.Ra.ha(t),Sm(r)):r.Ra.set("Unknown")}async function OR(r,t,i){if(r.Ra.set("Online"),t instanceof nv&&t.state===2&&t.cause)try{await(async function(l,c){const d=c.cause;for(const g of c.targetIds)l.Ia.has(g)&&(await l.remoteSyncer.rejectListen(g,d),l.Ia.delete(g),l.Va.removeTarget(g))})(r,t)}catch(a){st(fo,"Failed to remove targets %s: %s ",t.targetIds.join(","),a),await f1(r,a)}else if(t instanceof Jc?r.Va.Ze(t):t instanceof ev?r.Va.st(t):r.Va.tt(t),!i.isEqual(St.min()))try{const a=await fv(r.localStore);i.compareTo(a)>=0&&await(function(c,d){const g=c.Va.Tt(d);return g.targetChanges.forEach(((y,v)=>{if(y.resumeToken.approximateByteSize()>0){const S=c.Ia.get(v);S&&c.Ia.set(v,S.withResumeToken(y.resumeToken,d))}})),g.targetMismatches.forEach(((y,v)=>{const S=c.Ia.get(y);if(!S)return;c.Ia.set(y,S.withResumeToken(Xe.EMPTY_BYTE_STRING,S.snapshotVersion)),gv(c,y);const b=new Wr(S.target,y,v,S.sequenceNumber);Tm(c,b)})),c.remoteSyncer.applyRemoteEvent(g)})(r,i)}catch(a){st(fo,"Failed to raise snapshot:",a),await f1(r,a)}}async function f1(r,t,i){if(!So(t))throw t;r.Ea.add(1),await ru(r),r.Ra.set("Offline"),i||(i=()=>fv(r.localStore)),r.asyncQueue.enqueueRetryable((async()=>{st(fo,"Retrying IndexedDB access"),await i(),r.Ea.delete(1),await jh(r)}))}async function d1(r,t){const i=Bt(r);i.asyncQueue.verifyOperationInProgress(),st(fo,"RemoteStore received new credentials");const a=su(i);i.Ea.add(3),await ru(i),a&&i.Ra.set("Unknown"),await i.remoteSyncer.handleCredentialChange(t),i.Ea.delete(3),await jh(i)}async function xR(r,t){const i=Bt(r);t?(i.Ea.delete(2),await jh(i)):t||(i.Ea.add(2),await ru(i),i.Ra.set("Unknown"))}function Ao(r){return r.ma||(r.ma=(function(i,a,l){const c=Bt(i);return c.sa(),new AR(a,c.connection,c.authCredentials,c.appCheckCredentials,c.serializer,l)})(r.datastore,r.asyncQueue,{Xo:IR.bind(null,r),t_:DR.bind(null,r),r_:NR.bind(null,r),H_:OR.bind(null,r)}),r.da.push((async t=>{t?(r.ma.B_(),Am(r)?Sm(r):r.Ra.set("Unknown")):(await r.ma.stop(),yv(r))}))),r.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vv{constructor(t){this.key=t}}class Ev{constructor(t){this.key=t}}class BR{constructor(t,i){this.query=t,this.Ya=i,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=jt(),this.mutatedKeys=jt(),this.eu=K2(t),this.tu=new to(this.eu)}get nu(){return this.Ya}ru(t,i){const a=i?i.iu:new p1,l=i?i.tu:this.tu;let c=i?i.mutatedKeys:this.mutatedKeys,d=l,g=!1;const y=this.query.limitType==="F"&&l.size===this.query.limit?l.last():null,v=this.query.limitType==="L"&&l.size===this.query.limit?l.first():null;if(t.inorderTraversal(((S,b)=>{const x=l.get(S),q=kh(this.query,b)?b:null,$=!!x&&this.mutatedKeys.has(x.key),Z=!!q&&(q.hasLocalMutations||this.mutatedKeys.has(q.key)&&q.hasCommittedMutations);let X=!1;x&&q?x.data.isEqual(q.data)?$!==Z&&(a.track({type:3,doc:q}),X=!0):this.su(x,q)||(a.track({type:2,doc:q}),X=!0,(y&&this.eu(q,y)>0||v&&this.eu(q,v)<0)&&(g=!0)):!x&&q?(a.track({type:0,doc:q}),X=!0):x&&!q&&(a.track({type:1,doc:x}),X=!0,(y||v)&&(g=!0)),X&&(q?(d=d.add(q),c=Z?c.add(S):c.delete(S)):(d=d.delete(S),c=c.delete(S)))})),this.query.limit!==null)for(;d.size>this.query.limit;){const S=this.query.limitType==="F"?d.last():d.first();d=d.delete(S.key),c=c.delete(S.key),a.track({type:1,doc:S})}return{tu:d,iu:a,Cs:g,mutatedKeys:c}}su(t,i){return t.hasLocalMutations&&i.hasCommittedMutations&&!i.hasLocalMutations}applyChanges(t,i,a,l){const c=this.tu;this.tu=t.tu,this.mutatedKeys=t.mutatedKeys;const d=t.iu.ya();d.sort(((S,b)=>(function(q,$){const Z=X=>{switch(X){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return bt(20277,{Rt:X})}};return Z(q)-Z($)})(S.type,b.type)||this.eu(S.doc,b.doc))),this.ou(a),l=l??!1;const g=i&&!l?this._u():[],y=this.Xa.size===0&&this.current&&!l?1:0,v=y!==this.Za;return this.Za=y,d.length!==0||v?{snapshot:new po(this.query,t.tu,c,d,t.mutatedKeys,y===0,v,!1,!!a&&a.resumeToken.approximateByteSize()>0),au:g}:{au:g}}va(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new p1,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(t){return!this.Ya.has(t)&&!!this.tu.has(t)&&!this.tu.get(t).hasLocalMutations}ou(t){t&&(t.addedDocuments.forEach((i=>this.Ya=this.Ya.add(i))),t.modifiedDocuments.forEach((i=>{})),t.removedDocuments.forEach((i=>this.Ya=this.Ya.delete(i))),this.current=t.current)}_u(){if(!this.current)return[];const t=this.Xa;this.Xa=jt(),this.tu.forEach((a=>{this.uu(a.key)&&(this.Xa=this.Xa.add(a.key))}));const i=[];return t.forEach((a=>{this.Xa.has(a)||i.push(new Ev(a))})),this.Xa.forEach((a=>{t.has(a)||i.push(new vv(a))})),i}cu(t){this.Ya=t.Qs,this.Xa=jt();const i=this.ru(t.documents);return this.applyChanges(i,!0)}lu(){return po.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const Rm="SyncEngine";class jR{constructor(t,i,a){this.query=t,this.targetId=i,this.view=a}}class qR{constructor(t){this.key=t,this.hu=!1}}class HR{constructor(t,i,a,l,c,d){this.localStore=t,this.remoteStore=i,this.eventManager=a,this.sharedClientState=l,this.currentUser=c,this.maxConcurrentLimboResolutions=d,this.Pu={},this.Tu=new ia((g=>G2(g)),Lh),this.Iu=new Map,this.Eu=new Set,this.du=new ve(_t.comparator),this.Au=new Map,this.Ru=new gm,this.Vu={},this.mu=new Map,this.fu=ho.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function FR(r,t,i=!0){const a=wv(r);let l;const c=a.Tu.get(t);return c?(a.sharedClientState.addLocalQueryTarget(c.targetId),l=c.view.lu()):l=await Tv(a,t,i,!0),l}async function GR(r,t){const i=wv(r);await Tv(i,t,!0,!1)}async function Tv(r,t,i,a){const l=await pR(r.localStore,Mi(t)),c=l.targetId,d=r.sharedClientState.addLocalQueryTarget(c,i);let g;return a&&(g=await KR(r,t,c,d==="current",l.resumeToken)),r.isPrimaryClient&&i&&mv(r.remoteStore,l),g}async function KR(r,t,i,a,l){r.pu=(b,x,q)=>(async function(Z,X,rt,ct){let nt=X.view.ru(rt);nt.Cs&&(nt=await o1(Z.localStore,X.query,!1).then((({documents:A})=>X.view.ru(A,nt))));const lt=ct&&ct.targetChanges.get(X.targetId),yt=ct&&ct.targetMismatches.get(X.targetId)!=null,at=X.view.applyChanges(nt,Z.isPrimaryClient,lt,yt);return _1(Z,X.targetId,at.au),at.snapshot})(r,b,x,q);const c=await o1(r.localStore,t,!0),d=new BR(t,c.Qs),g=d.ru(c.documents),y=iu.createSynthesizedTargetChangeForCurrentChange(i,a&&r.onlineState!=="Offline",l),v=d.applyChanges(g,r.isPrimaryClient,y);_1(r,i,v.au);const S=new jR(t,i,d);return r.Tu.set(t,S),r.Iu.has(i)?r.Iu.get(i).push(t):r.Iu.set(i,[t]),v.snapshot}async function YR(r,t,i){const a=Bt(r),l=a.Tu.get(t),c=a.Iu.get(l.targetId);if(c.length>1)return a.Iu.set(l.targetId,c.filter((d=>!Lh(d,t)))),void a.Tu.delete(t);a.isPrimaryClient?(a.sharedClientState.removeLocalQueryTarget(l.targetId),a.sharedClientState.isActiveQueryTarget(l.targetId)||await jp(a.localStore,l.targetId,!1).then((()=>{a.sharedClientState.clearQueryState(l.targetId),i&&Em(a.remoteStore,l.targetId),Fp(a,l.targetId)})).catch(Oh)):(Fp(a,l.targetId),await jp(a.localStore,l.targetId,!0))}async function QR(r,t){const i=Bt(r),a=i.Tu.get(t),l=i.Iu.get(a.targetId);i.isPrimaryClient&&l.length===1&&(i.sharedClientState.removeLocalQueryTarget(a.targetId),Em(i.remoteStore,a.targetId))}async function Sv(r,t){const i=Bt(r);try{const a=await fR(i.localStore,t);t.targetChanges.forEach(((l,c)=>{const d=i.Au.get(c);d&&(ce(l.addedDocuments.size+l.modifiedDocuments.size+l.removedDocuments.size<=1,22616),l.addedDocuments.size>0?d.hu=!0:l.modifiedDocuments.size>0?ce(d.hu,14607):l.removedDocuments.size>0&&(ce(d.hu,42227),d.hu=!1))})),await bv(i,a,t)}catch(a){await Oh(a)}}function y1(r,t,i){const a=Bt(r);if(a.isPrimaryClient&&i===0||!a.isPrimaryClient&&i===1){const l=[];a.Tu.forEach(((c,d)=>{const g=d.view.va(t);g.snapshot&&l.push(g.snapshot)})),(function(d,g){const y=Bt(d);y.onlineState=g;let v=!1;y.queries.forEach(((S,b)=>{for(const x of b.Sa)x.va(g)&&(v=!0)})),v&&wm(y)})(a.eventManager,t),l.length&&a.Pu.H_(l),a.onlineState=t,a.isPrimaryClient&&a.sharedClientState.setOnlineState(t)}}async function XR(r,t,i){const a=Bt(r);a.sharedClientState.updateQueryState(t,"rejected",i);const l=a.Au.get(t),c=l&&l.key;if(c){let d=new ve(_t.comparator);d=d.insert(c,We.newNoDocument(c,St.min()));const g=jt().add(c),y=new Bh(St.min(),new Map,new ve(kt),d,g);await Sv(a,y),a.du=a.du.remove(c),a.Au.delete(t),Cm(a)}else await jp(a.localStore,t,!1).then((()=>Fp(a,t,i))).catch(Oh)}function Fp(r,t,i=null){r.sharedClientState.removeLocalQueryTarget(t);for(const a of r.Iu.get(t))r.Tu.delete(a),i&&r.Pu.yu(a,i);r.Iu.delete(t),r.isPrimaryClient&&r.Ru.jr(t).forEach((a=>{r.Ru.containsKey(a)||Av(r,a)}))}function Av(r,t){r.Eu.delete(t.path.canonicalString());const i=r.du.get(t);i!==null&&(Em(r.remoteStore,i),r.du=r.du.remove(t),r.Au.delete(i),Cm(r))}function _1(r,t,i){for(const a of i)a instanceof vv?(r.Ru.addReference(a.key,t),$R(r,a)):a instanceof Ev?(st(Rm,"Document no longer in limbo: "+a.key),r.Ru.removeReference(a.key,t),r.Ru.containsKey(a.key)||Av(r,a.key)):bt(19791,{wu:a})}function $R(r,t){const i=t.key,a=i.path.canonicalString();r.du.get(i)||r.Eu.has(a)||(st(Rm,"New document in limbo: "+i),r.Eu.add(a),Cm(r))}function Cm(r){for(;r.Eu.size>0&&r.du.size<r.maxConcurrentLimboResolutions;){const t=r.Eu.values().next().value;r.Eu.delete(t);const i=new _t(ue.fromString(t)),a=r.fu.next();r.Au.set(a,new qR(i)),r.du=r.du.insert(i,a),mv(r.remoteStore,new Wr(Mi(F2(i.path)),a,"TargetPurposeLimboResolution",xh.ce))}}async function bv(r,t,i){const a=Bt(r),l=[],c=[],d=[];a.Tu.isEmpty()||(a.Tu.forEach(((g,y)=>{d.push(a.pu(y,t,i).then((v=>{if((v||i)&&a.isPrimaryClient){const S=v?!v.fromCache:i?.targetChanges.get(y.targetId)?.current;a.sharedClientState.updateQueryState(y.targetId,S?"current":"not-current")}if(v){l.push(v);const S=_m.As(y.targetId,v);c.push(S)}})))})),await Promise.all(d),a.Pu.H_(l),await(async function(y,v){const S=Bt(y);try{await S.persistence.runTransaction("notifyLocalViewChanges","readwrite",(b=>Q.forEach(v,(x=>Q.forEach(x.Es,(q=>S.persistence.referenceDelegate.addReference(b,x.targetId,q))).next((()=>Q.forEach(x.ds,(q=>S.persistence.referenceDelegate.removeReference(b,x.targetId,q)))))))))}catch(b){if(!So(b))throw b;st(vm,"Failed to update sequence numbers: "+b)}for(const b of v){const x=b.targetId;if(!b.fromCache){const q=S.Ms.get(x),$=q.snapshotVersion,Z=q.withLastLimboFreeSnapshotVersion($);S.Ms=S.Ms.insert(x,Z)}}})(a.localStore,c))}async function ZR(r,t){const i=Bt(r);if(!i.currentUser.isEqual(t)){st(Rm,"User change. New user:",t.toKey());const a=await hv(i.localStore,t);i.currentUser=t,(function(c,d){c.mu.forEach((g=>{g.forEach((y=>{y.reject(new pt(W.CANCELLED,d))}))})),c.mu.clear()})(i,"'waitForPendingWrites' promise is rejected due to a user change."),i.sharedClientState.handleUserChange(t,a.removedBatchIds,a.addedBatchIds),await bv(i,a.Ls)}}function JR(r,t){const i=Bt(r),a=i.Au.get(t);if(a&&a.hu)return jt().add(a.key);{let l=jt();const c=i.Iu.get(t);if(!c)return l;for(const d of c){const g=i.Tu.get(d);l=l.unionWith(g.view.nu)}return l}}function wv(r){const t=Bt(r);return t.remoteStore.remoteSyncer.applyRemoteEvent=Sv.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=JR.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=XR.bind(null,t),t.Pu.H_=kR.bind(null,t.eventManager),t.Pu.yu=PR.bind(null,t.eventManager),t}class gh{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=dv(t.databaseInfo.databaseId),this.sharedClientState=this.Du(t),this.persistence=this.Cu(t),await this.persistence.start(),this.localStore=this.vu(t),this.gcScheduler=this.Fu(t,this.localStore),this.indexBackfillerScheduler=this.Mu(t,this.localStore)}Fu(t,i){return null}Mu(t,i){return null}vu(t){return hR(this.persistence,new lR,t.initialUser,this.serializer)}Cu(t){return new cv(ym.mi,this.serializer)}Du(t){return new gR}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}gh.provider={build:()=>new gh};class WR extends gh{constructor(t){super(),this.cacheSizeBytes=t}Fu(t,i){ce(this.persistence.referenceDelegate instanceof mh,46915);const a=this.persistence.referenceDelegate.garbageCollector;return new Yw(a,t.asyncQueue,i)}Cu(t){const i=this.cacheSizeBytes!==void 0?pn.withCacheSize(this.cacheSizeBytes):pn.DEFAULT;return new cv((a=>mh.mi(a,i)),this.serializer)}}class Gp{async initialize(t,i){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(i),this.remoteStore=this.createRemoteStore(i),this.eventManager=this.createEventManager(i),this.syncEngine=this.createSyncEngine(i,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=a=>y1(this.syncEngine,a,1),this.remoteStore.remoteSyncer.handleCredentialChange=ZR.bind(null,this.syncEngine),await xR(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return(function(){return new VR})()}createDatastore(t){const i=dv(t.databaseInfo.databaseId),a=(function(c){return new TR(c)})(t.databaseInfo);return(function(c,d,g,y){return new wR(c,d,g,y)})(t.authCredentials,t.appCheckCredentials,a,i)}createRemoteStore(t){return(function(a,l,c,d,g){return new CR(a,l,c,d,g)})(this.localStore,this.datastore,t.asyncQueue,(i=>y1(this.syncEngine,i,0)),(function(){return c1.v()?new c1:new yR})())}createSyncEngine(t,i){return(function(l,c,d,g,y,v,S){const b=new HR(l,c,d,g,y,v);return S&&(b.gu=!0),b})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,i)}async terminate(){await(async function(i){const a=Bt(i);st(fo,"RemoteStore shutting down."),a.Ea.add(5),await ru(a),a.Aa.shutdown(),a.Ra.set("Unknown")})(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}Gp.provider={build:()=>new Gp};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tC{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.Ou(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.Ou(this.observer.error,t):cr("Uncaught Error in snapshot listener:",t.toString()))}Nu(){this.muted=!0}Ou(t,i){setTimeout((()=>{this.muted||t(i)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rv(r){const t={};return r.timeoutSeconds!==void 0&&(t.timeoutSeconds=r.timeoutSeconds),t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dv{constructor(...t){for(let i=0;i<t.length;++i)if(t[i].length===0)throw new pt(W.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new an(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nv{constructor(t,i,a,l,c){this._firestore=t,this._userDataWriter=i,this._key=a,this._document=l,this._converter=c}get id(){return this._key.path.lastSegment()}get ref(){return new zn(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const t=new dC(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){const i=this._document.data.field(Ov("DocumentSnapshot.get",t));if(i!==null)return this._userDataWriter.convertValue(i)}}}class dC extends Nv{data(){return super.data()}}function Ov(r,t){return typeof t=="string"?fC(r,t):t instanceof Dv?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kp(){return typeof self<"u"&&self.location?.href||""}function TC(){return C1()==="http:"||C1()==="https:"}function C1(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class au{constructor(t,i){this.shortDelay=t,this.longDelay=i,fr(i>t,"Short delay should be less than long delay!"),this.isMobile=qS()||KS()}get(){return SC()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wC=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],RC=new au(3e4,6e4);function Om(r,t){return r.tenantId&&!t.tenantId?{...t,tenantId:r.tenantId}:t}async function bo(r,t,i,a,l={}){return Lv(r,l,async()=>{let c={},d={};a&&(t==="GET"?d=a:c={body:JSON.stringify(a)});const g=tu({key:r.config.apiKey,...d}).slice(1),y=await r._getAdditionalHeaders();y["Content-Type"]="application/json",r.languageCode&&(y["X-Firebase-Locale"]=r.languageCode);const v={method:t,headers:y,...c};return FS()||(v.referrerPolicy="no-referrer"),r.emulatorConfig&&ea(r.emulatorConfig.host)&&(v.credentials="include"),Uv.fetch()(await kv(r,r.config.apiHost,i,g),v)})}async function Lv(r,t,i){r._canInitEmulator=!1;const a={...bC,...t};try{const l=new IC(r),c=await Promise.race([i(),l.promise]);l.clearNetworkTimeout();const d=await c.json();if("needConfirmation"in d)throw Gc(r,"account-exists-with-different-credential",d);if(c.ok&&!("errorMessage"in d))return d;{const g=c.ok?d.errorMessage:d.error.message,[y,v]=g.split(" : ");if(y==="FEDERATED_USER_ID_ALREADY_LINKED")throw Gc(r,"credential-already-in-use",d);if(y==="EMAIL_EXISTS")throw Gc(r,"email-already-in-use",d);if(y==="USER_DISABLED")throw Gc(r,"user-disabled",d);const S=a[y]||y.toLowerCase().replace(/[_\s]+/g,"-");if(v)throw Vv(r,S,v);hr(r,S)}}catch(l){if(l instanceof zi)throw l;hr(r,"network-request-failed",{message:String(l)})}}async function CC(r,t,i,a,l={}){const c=await bo(r,t,i,a,l);return"mfaPendingCredential"in c&&hr(r,"multi-factor-auth-required",{_serverResponse:c}),c}async function kv(r,t,i,a){const l=`${t}${i}?${a}`,c=r,d=c.config.emulator?Nm(r.config,l):`${r.config.apiScheme}://${l}`;return wC.includes(i)&&(await c._persistenceManagerAvailable,c._getPersistenceType()==="COOKIE")?c._getPersistence()._getFinalTarget(d).toString():d}class IC{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(t){this.auth=t,this.timer=null,this.promise=new Promise((i,a)=>{this.timer=setTimeout(()=>a(Vi(this.auth,"network-request-failed")),RC.get())})}}function Gc(r,t,i){const a={appName:r.name};i.email&&(a.email=i.email),i.phoneNumber&&(a.phoneNumber=i.phoneNumber);const l=Vi(r,t,a);return l.customData._tokenResponse=i,l}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jl(r){if(r)try{const t=new Date(Number(r));if(!isNaN(t.getTime()))return t.toUTCString()}catch{}}async function NC(r,t=!1){const i=fs(r),a=await i.getIdToken(t),l=xm(a);Et(l&&l.exp&&l.auth_time&&l.iat,i.auth,"internal-error");const c=typeof l.firebase=="object"?l.firebase:void 0,d=c?.sign_in_provider;return{claims:l,token:a,authTime:jl(pp(l.auth_time)),issuedAtTime:jl(pp(l.iat)),expirationTime:jl(pp(l.exp)),signInProvider:d||null,signInSecondFactor:c?.sign_in_second_factor||null}}function pp(r){return Number(r)*1e3}function xm(r){const[t,i,a]=r.split(".");if(t===void 0||i===void 0||a===void 0)return th("JWT malformed, contained fewer than 3 sections"),null;try{const l=f2(i);return l?JSON.parse(l):(th("Failed to decode base64 JWT payload"),null)}catch(l){return th("Caught error parsing JWT payload as JSON",l?.toString()),null}}function I1(r){const t=xm(r);return Et(t,"internal-error"),Et(typeof t.exp<"u","internal-error"),Et(typeof t.iat<"u","internal-error"),Number(t.exp)-Number(t.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $l(r,t,i=!1){if(i)return t;try{return await t}catch(a){throw a instanceof zi&&OC(a)&&r.auth.currentUser===r&&await r.auth.signOut(),a}}function OC({code:r}){return r==="auth/user-disabled"||r==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vh(r){const t=r.auth,i=await r.getIdToken(),a=await $l(r,_h(t,{idToken:i}));Et(a?.users.length,t,"internal-error");const l=a.users[0];r._notifyReloadListener(l);const c=l.providerUserInfo?.length?Pv(l.providerUserInfo):[],d=VC(r.providerData,c),g=r.isAnonymous,y=!(r.email&&l.passwordHash)&&!d?.length,v=g?y:!1,S={uid:l.localId,displayName:l.displayName||null,photoURL:l.photoUrl||null,email:l.email||null,emailVerified:l.emailVerified||!1,phoneNumber:l.phoneNumber||null,tenantId:l.tenantId||null,providerData:d,metadata:new Yp(l.createdAt,l.lastLoginAt),isAnonymous:v};Object.assign(r,S)}async function MC(r){const t=fs(r);await vh(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function VC(r,t){return[...r.filter(a=>!t.some(l=>l.providerId===a.providerId)),...t]}function Pv(r){return r.map(({providerId:t,...i})=>({providerId:t,uid:i.rawId||"",displayName:i.displayName||null,email:i.email||null,phoneNumber:i.phoneNumber||null,photoURL:i.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function UC(r,t){const i=await Lv(r,{},async()=>{const a=tu({grant_type:"refresh_token",refresh_token:t}).slice(1),{tokenApiHost:l,apiKey:c}=r.config,d=await kv(r,l,"/v1/token",`key=${c}`),g=await r._getAdditionalHeaders();g["Content-Type"]="application/x-www-form-urlencoded";const y={method:"POST",headers:g,body:a};return r.emulatorConfig&&ea(r.emulatorConfig.host)&&(y.credentials="include"),Uv.fetch()(d,y)});return{accessToken:i.access_token,expiresIn:i.expires_in,refreshToken:i.refresh_token}}async function LC(r,t){return bo(r,"POST","/v2/accounts:revokeToken",Om(r,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D1=new Map;function lr(r){fr(r instanceof Function,"Expected a class definition");let t=D1.get(r);return t?(fr(t instanceof r,"Instance stored in cache mismatched with class"),t):(t=new r,D1.set(r,t),t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zv{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(t,i){this.storage[t]=i}async _get(t){const i=this.storage[t];return i===void 0?null:i}async _remove(t){delete this.storage[t]}_addListener(t,i){}_removeListener(t,i){}}zv.type="NONE";const N1=zv;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O1(r){const t=r.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Hv(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Bv(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Gv(t))return"Blackberry";if(Kv(t))return"Webos";if(jv(t))return"Safari";if((t.includes("chrome/")||qv(t))&&!t.includes("edge/"))return"Chrome";if(Fv(t))return"Android";{const i=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,a=r.match(i);if(a?.length===2)return a[1]}return"Other"}function Bv(r=tn()){return/firefox\//i.test(r)}function jv(r=tn()){const t=r.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function qv(r=tn()){return/crios\//i.test(r)}function Hv(r=tn()){return/iemobile/i.test(r)}function Fv(r=tn()){return/android/i.test(r)}function Gv(r=tn()){return/blackberry/i.test(r)}function Kv(r=tn()){return/webos/i.test(r)}function Mm(r=tn()){return/iphone|ipad|ipod/i.test(r)||/macintosh/i.test(r)&&/mobile/i.test(r)}function kC(r=tn()){return Mm(r)&&!!window.navigator?.standalone}function PC(){return YS()&&document.documentMode===10}function Yv(r=tn()){return Mm(r)||Fv(r)||Kv(r)||Gv(r)||/windows phone/i.test(r)||Hv(r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qv(r,t=[]){let i;switch(r){case"Browser":i=O1(tn());break;case"Worker":i=`${O1(tn())}-${r}`;break;default:i=r}const a=t.length?t.join(","):"FirebaseCore-web";return`${i}/JsCore/${na}/${a}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Um={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function FC(r){Um=r}function GC(r){return Um.loadJS(r)}function KC(){return Um.gapiScript}function YC(r){return`__${r}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $v{constructor(t,i){this.providerId=t,this.signInMethod=i}toJSON(){return or("not implemented")}_getIdTokenResponse(t){return or("not implemented")}_linkToIdToken(t,i){return or("not implemented")}_getReauthenticationResolver(t){return or("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ou extends Zv{constructor(){super(...arguments),this.scopes=[]}addScope(t){return this.scopes.includes(t)||this.scopes.push(t),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo{constructor(t){this.user=t.user,this.providerId=t.providerId,this._tokenResponse=t._tokenResponse,this.operationType=t.operationType}static async _fromIdTokenResponse(t,i,a,l=!1){const c=await ii._fromIdTokenResponse(t,a,l),d=V1(a);return new mo({user:c,providerId:d,_tokenResponse:a,operationType:i})}static async _forOperation(t,i,a){await t._updateTokensIfNecessary(a,!0);const l=V1(a);return new mo({user:t,providerId:l,_tokenResponse:a,operationType:i})}}function V1(r){return r.providerId?r.providerId:"phoneNumber"in r?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eh extends zi{constructor(t,i,a,l){super(i.code,i.message),this.operationType=a,this.user=l,Object.setPrototypeOf(this,Eh.prototype),this.customData={appName:t.name,tenantId:t.tenantId??void 0,_serverResponse:i.customData._serverResponse,operationType:a}}static _fromErrorAndOperation(t,i,a,l){return new Eh(t,i,a,l)}}function Jv(r,t,i,a){return(t==="reauthenticate"?i._getReauthenticationResolver(r):i._getIdTokenResponse(r)).catch(c=>{throw c.code==="auth/multi-factor-auth-required"?Eh._fromErrorAndOperation(r,c,t,a):c})}async function t3(r,t,i=!1){const a=await $l(r,t._linkToIdToken(r.auth,await r.getIdToken()),i);return mo._forOperation(r,"link",a)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e3(r,t,i=!1){const{auth:a}=r;if(ni(a.app))return Promise.reject(Qs(a));const l="reauthenticate";try{const c=await $l(r,Jv(a,l,t,r),i);Et(c.idToken,a,"internal-error");const d=xm(c.idToken);Et(d,a,"internal-error");const{sub:g}=d;return Et(r.uid===g,a,"user-mismatch"),mo._forOperation(r,l,c)}catch(c){throw c?.code==="auth/user-not-found"&&hr(a,"user-mismatch"),c}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function n3(r,t,i=!1){if(ni(r.app))return Promise.reject(Qs(r));const a="signIn",l=await Jv(r,a,t),c=await mo._fromIdTokenResponse(r,a,l);return i||await r._updateCurrentUser(c.user),c}function i3(r,t,i,a){return fs(r).onIdTokenChanged(t,i,a)}function r3(r,t,i){return fs(r).beforeAuthStateChanged(t,i)}const Th="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wv{constructor(t,i){this.storageRetriever=t,this.type=i}_isAvailable(){try{return this.storage?(this.storage.setItem(Th,"1"),this.storage.removeItem(Th),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(t,i){return this.storage.setItem(t,JSON.stringify(i)),Promise.resolve()}_get(t){const i=this.storage.getItem(t);return Promise.resolve(i?JSON.parse(i):null)}_remove(t){return this.storage.removeItem(t),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eE extends Wv{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(t,i){}_removeListener(t,i){}}eE.type="SESSION";const nE=eE;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ui(){return window}function c3(r){Ui().location.href=r}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iE(){return typeof Ui().WorkerGlobalScope<"u"&&typeof Ui().importScripts=="function"}async function h3(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function f3(){return navigator?.serviceWorker?.controller||null}function d3(){return iE()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function E3(r,t){return t?lr(t):(Et(r._popupRedirectResolver,r,"argument-error"),r._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oE{constructor(t,i,a,l,c=!1){this.auth=t,this.resolver=a,this.user=l,this.bypassAuthState=c,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(i)?i:[i]}execute(){return new Promise(async(t,i)=>{this.pendingPromise={resolve:t,reject:i};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(a){this.reject(a)}})}async onAuthEvent(t){const{urlResponse:i,sessionId:a,postBody:l,tenantId:c,error:d,type:g}=t;if(d){this.reject(d);return}const y={auth:this.auth,requestUri:i,sessionId:a,tenantId:c||void 0,postBody:l||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(g)(y))}catch(v){this.reject(v)}}onError(t){this.reject(t)}getIdpTask(t){switch(t){case"signInViaPopup":case"signInViaRedirect":return T3;case"linkViaPopup":case"linkViaRedirect":return A3;case"reauthViaPopup":case"reauthViaRedirect":return S3;default:hr(this.auth,"internal-error")}}resolve(t){fr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(t),this.unregisterAndCleanUp()}reject(t){fr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(t),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const w3="pendingRedirect",nh=new Map;class R3 extends oE{constructor(t,i,a=!1){super(t,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],i,void 0,a),this.eventId=null}async execute(){let t=nh.get(this.auth._key());if(!t){try{const a=await C3(this.resolver,this.auth)?await super.execute():null;t=()=>Promise.resolve(a)}catch(i){t=()=>Promise.reject(i)}nh.set(this.auth._key(),t)}return this.bypassAuthState||nh.set(this.auth._key(),()=>Promise.resolve(null)),t()}async onAuthEvent(t){if(t.type==="signInViaRedirect")return super.onAuthEvent(t);if(t.type==="unknown"){this.resolve(null);return}if(t.eventId){const i=await this.auth._redirectUserForId(t.eventId);if(i)return this.user=i,super.onAuthEvent(t);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function C3(r,t){const i=N3(t),a=D3(r);if(!await a._isAvailable())return!1;const l=await a._get(i)==="true";return await a._remove(i),l}function I3(r,t){nh.set(r._key(),t)}function D3(r){return lr(r._redirectPersistence)}function N3(r){return eh(w3,r.config.apiKey,r.name)}async function O3(r,t,i=!1){if(ni(r.app))return Promise.reject(Qs(r));const a=Vm(r),l=E3(a,t),d=await new R3(a,l,i).execute();return d&&!i&&(delete d.user._redirectEventId,await a._persistUserIfCurrent(d.user),await a._setRedirectUser(null,t)),d}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const B3=new au(3e4,6e4);function P1(){const r=Ui().___jsl;if(r?.H){for(const t of Object.keys(r.H))if(r.H[t].r=r.H[t].r||[],r.H[t].L=r.H[t].L||[],r.H[t].r=[...r.H[t].L],r.CP)for(let i=0;i<r.CP.length;i++)r.CP[i]=null}}function j3(r){return new Promise((t,i)=>{function a(){P1(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{P1(),i(Vi(r,"network-request-failed"))},timeout:B3.get()})}if(Ui().gapi?.iframes?.Iframe)t(gapi.iframes.getContext());else if(Ui().gapi?.load)a();else{const l=YC("iframefcb");return Ui()[l]=()=>{gapi.load?a():i(Vi(r,"network-request-failed"))},GC(`${KC()}?onload=${l}`).catch(c=>i(c))}}).catch(t=>{throw ih=null,t})}let ih=null;function q3(r){return ih=ih||j3(r),ih}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H3=new au(5e3,15e3),F3="__/auth/iframe",G3="emulator/auth/iframe",K3={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Y3=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Q3(r){const t=r.config;Et(t.authDomain,r,"auth-domain-config-required");const i=t.emulator?Nm(t,G3):`https://${r.config.authDomain}/${F3}`,a={apiKey:t.apiKey,appName:r.name,v:na},l=Y3.get(r.config.apiHost);l&&(a.eid=l);const c=r._getFrameworks();return c.length&&(a.fw=c.join(",")),`${i}?${tu(a).slice(1)}`}async function X3(r){const t=await q3(r),i=Ui().gapi;return Et(i,r,"internal-error"),t.open({where:document.body,url:Q3(r),messageHandlersFilter:i.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:K3,dontclear:!0},a=>new Promise(async(l,c)=>{await a.restyle({setHideOnLeave:!1});const d=Vi(r,"network-request-failed"),g=Ui().setTimeout(()=>{c(d)},H3.get());function y(){Ui().clearTimeout(g),l(a)}a.ping(y).then(y,()=>{c(d)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mp="webStorageSupport";class o4{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=nE,this._completeRedirectFn=O3,this._overrideRedirectResult=I3}async _openPopup(t,i,a,l){fr(this.eventManagers[t._key()]?.manager,"_initialize() not called before _openPopup()");const c=await B1(t,i,a,Kp(),l);return e4(t,c,Lm())}async _openRedirect(t,i,a,l){await this._originValidation(t);const c=await B1(t,i,a,Kp(),l);return c3(c),new Promise(()=>{})}_initialize(t){const i=t._key();if(this.eventManagers[i]){const{manager:l,promise:c}=this.eventManagers[i];return l?Promise.resolve(l):(fr(c,"If manager is not set, promise should be"),c)}const a=this.initAndGetManager(t);return this.eventManagers[i]={promise:a},a.catch(()=>{delete this.eventManagers[i]}),a}async initAndGetManager(t){const i=await X3(t),a=new M3(t);return i.register("authEvent",l=>(Et(l?.authEvent,t,"invalid-auth-event"),{status:a.onEvent(l.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[t._key()]={manager:a},this.iframes[t._key()]=i,a}_isIframeWebStorageSupported(t,i){this.iframes[t._key()].send(mp,{type:mp},l=>{const c=l?.[0]?.[mp];c!==void 0&&i(!!c),hr(t,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(t){const i=t._key();return this.originValidationPromises[i]||(this.originValidationPromises[i]=P3(t)),this.originValidationPromises[i]}get _shouldInitProactively(){return Yv()||jv()||Mm()}}const l4=o4;var j1="@firebase/auth",q1="1.11.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function c4(r){switch(r){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function h4(r){Js(new ss("auth",(t,{options:i})=>{const a=t.getProvider("app").getImmediate(),l=t.getProvider("heartbeat"),c=t.getProvider("app-check-internal"),{apiKey:d,authDomain:g}=a.options;Et(d&&!d.includes(":"),"invalid-api-key",{appName:a.name});const y={apiKey:d,authDomain:g,clientPlatform:r,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Qv(r)},v=new HC(a,l,c,y);return XC(v,i),v},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,i,a)=>{t.getProvider("auth-internal").initialize()})),Js(new ss("auth-internal",t=>{const i=Vm(t.getProvider("auth").getImmediate());return(a=>new u4(a))(i)},"PRIVATE").setInstantiationMode("EXPLICIT")),xi(j1,q1,c4(r)),xi(j1,q1,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f4=300,d4=g2("authIdTokenMaxAge")||f4;let H1=null;const p4=r=>async t=>{const i=t&&await t.getIdTokenResult(),a=i&&(new Date().getTime()-Date.parse(i.issuedAtTime))/1e3;if(a&&a>d4)return;const l=i?.token;H1!==l&&(H1=l,await fetch(r,{method:l?"POST":"DELETE",headers:l?{Authorization:`Bearer ${l}`}:{}}))};function m4(r=Nh()){const t=Dh(r,"auth");if(t.isInitialized())return t.getImmediate();const i=QC(r,{popupRedirectResolver:l4,persistence:[v3,o3,nE]}),a=g2("authTokenSyncURL");if(a&&typeof isSecureContext=="boolean"&&isSecureContext){const c=new URL(a,location.origin);if(location.origin===c.origin){const d=p4(c.toString());r3(i,d,()=>d(i.currentUser)),i3(i,g=>d(g))}}const l=d2("auth");return l&&$C(i,`http://${l}`),i}function g4(){return document.getElementsByTagName("head")?.[0]??document}FC({loadJS(r){return new Promise((t,i)=>{const a=document.createElement("script");a.setAttribute("src",r),a.onload=t,a.onerror=l=>{const c=Vi("internal-error");c.customData=l,i(c)},a.type="text/javascript",a.charset="UTF-8",g4().appendChild(a)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});h4("Browser");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uE="firebasestorage.googleapis.com",y4="storageBucket",_4=120*1e3,v4=600*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ri{constructor(t,i){this.bucket=t,this.path_=i}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,i){let a;try{a=ri.makeFromUrl(t,i)}catch{return new ri(t,"")}if(a.path==="")return a;throw b4(t)}static makeFromUrl(t,i){let a=null;const l="([A-Za-z0-9.\\-_]+)";function c(lt){lt.path.charAt(lt.path.length-1)==="/"&&(lt.path_=lt.path_.slice(0,-1))}const d="(/(.*))?$",g=new RegExp("^gs://"+l+d,"i"),y={bucket:1,path:3};function v(lt){lt.path_=decodeURIComponent(lt.path)}const S="v[A-Za-z0-9_]+",b=i.replace(/[.]/g,"\\."),x="(/([^?#]*).*)?$",q=new RegExp(`^https?://${b}/${S}/b/${l}/o${x}`,"i"),$={bucket:1,path:3},Z=i===uE?"(?:storage.googleapis.com|storage.cloud.google.com)":i,X="([^?#]*)",rt=new RegExp(`^https?://${Z}/${l}/${X}`,"i"),nt=[{regex:g,indices:y,postModify:c},{regex:q,indices:$,postModify:v},{regex:rt,indices:{bucket:1,path:2},postModify:v}];for(let lt=0;lt<nt.length;lt++){const yt=nt[lt],at=yt.regex.exec(t);if(at){const A=at[yt.indices.bucket];let w=at[yt.indices.path];w||(w=""),a=new ri(A,w),yt.postModify(a);break}}if(a==null)throw A4(t);return a}}class R4{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class x4{constructor(t,i,a,l,c,d,g,y,v,S,b,x=!0,q=!1){this.url_=t,this.method_=i,this.headers_=a,this.body_=l,this.successCodes_=c,this.additionalRetryCodes_=d,this.callback_=g,this.errorCallback_=y,this.timeout_=v,this.progressCallback_=S,this.connectionFactory_=b,this.retry=x,this.isUsingEmulator=q,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise(($,Z)=>{this.resolve_=$,this.reject_=Z,this.start_()})}start_(){const t=(a,l)=>{if(l){a(!1,new Kc(!1,null,!0));return}const c=this.connectionFactory_();this.pendingConnection_=c;const d=g=>{const y=g.loaded,v=g.lengthComputable?g.total:-1;this.progressCallback_!==null&&this.progressCallback_(y,v)};this.progressCallback_!==null&&c.addUploadProgressListener(d),c.send(this.url_,this.method_,this.isUsingEmulator,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&c.removeUploadProgressListener(d),this.pendingConnection_=null;const g=c.getErrorCode()===Ah.NO_ERROR,y=c.getStatus();if(!g||O4(y,this.additionalRetryCodes_)&&this.retry){const S=c.getErrorCode()===Ah.ABORT;a(!1,new Kc(!1,null,S));return}const v=this.successCodes_.indexOf(y)!==-1;a(!0,new Kc(v,c))})},i=(a,l)=>{const c=this.resolve_,d=this.reject_,g=l.connection;if(l.wasSuccessCode)try{const y=this.callback_(g,g.getResponse());D4(y)?c(y):c()}catch(y){d(y)}else if(g!==null){const y=E4();y.serverResponse=g.getErrorText(),this.errorCallback_?d(this.errorCallback_(g,y)):d(y)}else if(l.canceled){const y=this.appDelete_?cE():S4();d(y)}else{const y=T4();d(y)}};this.canceled_?i(!1,new Kc(!1,null,!0)):this.backoffId_=C4(t,i,this.timeout_)}getPromise(){return this.promise_}cancel(t){this.canceled_=!0,this.appDelete_=t||!1,this.backoffId_!==null&&I4(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class Kc{constructor(t,i,a){this.wasSuccessCode=t,this.connection=i,this.canceled=!!a}}function M4(r,t){t!==null&&t.length>0&&(r.Authorization="Firebase "+t)}function V4(r,t){r["X-Firebase-Storage-Version"]="webjs/"+(t??"AppManager")}function U4(r,t){t&&(r["X-Firebase-GMPID"]=t)}function L4(r,t){t!==null&&(r["X-Firebase-AppCheck"]=t)}function k4(r,t,i,a,l,c,d=!0,g=!1){const y=N4(r.urlParams),v=r.url+y,S=Object.assign({},r.headers);return U4(S,t),M4(S,i),V4(S,c),L4(S,a),new x4(v,r.method,S,r.body,r.successCodes,r.additionalRetryCodes,r.handler,r.errorHandler,r.timeout,r.progressCallback,l,d,g)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bh{constructor(t,i){this._service=t,i instanceof ri?this._location=i:this._location=ri.makeFromUrl(i,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,i){return new bh(t,i)}get root(){const t=new ri(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return z4(this._location.path)}get storage(){return this._service}get parent(){const t=P4(this._location.path);if(t===null)return null;const i=new ri(this._location.bucket,t);return new bh(this._service,i)}_throwIfRoot(t){if(this._location.path==="")throw w4(t)}}function K1(r,t){const i=t?.[y4];return i==null?null:ri.makeFromBucketSpec(i,r)}function B4(r,t,i,a={}){r.host=`${t}:${i}`;const l=ea(t);l&&(rm(`https://${r.host}/b`),sm("Storage",!0)),r._isUsingEmulator=!0,r._protocol=l?"https":"http";const{mockUserToken:c}=a;c&&(r._overrideAuthToken=typeof c=="string"?c:y2(c,r.app.options.projectId))}class j4{constructor(t,i,a,l,c,d=!1){this.app=t,this._authProvider=i,this._appCheckProvider=a,this._url=l,this._firebaseVersion=c,this._isUsingEmulator=d,this._bucket=null,this._host=uE,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=_4,this._maxUploadRetryTime=v4,this._requests=new Set,l!=null?this._bucket=ri.makeFromBucketSpec(l,this._host):this._bucket=K1(this._host,this.app.options)}get host(){return this._host}set host(t){this._host=t,this._url!=null?this._bucket=ri.makeFromBucketSpec(this._url,t):this._bucket=K1(t,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(t){G1("time",0,Number.POSITIVE_INFINITY,t),this._maxUploadRetryTime=t}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(t){G1("time",0,Number.POSITIVE_INFINITY,t),this._maxOperationRetryTime=t}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const t=this._authProvider.getImmediate({optional:!0});if(t){const i=await t.getToken();if(i!==null)return i.accessToken}return null}async _getAppCheckToken(){if(ni(this.app)&&this.app.settings.appCheckToken)return this.app.settings.appCheckToken;const t=this._appCheckProvider.getImmediate({optional:!0});return t?(await t.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(t=>t.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(t){return new bh(this,t)}_makeRequest(t,i,a,l,c=!0){if(this._deleted)return new R4(cE());{const d=k4(t,this._appId,a,l,i,this._firebaseVersion,c,this._isUsingEmulator);return this._requests.add(d),d.getPromise().then(()=>this._requests.delete(d),()=>this._requests.delete(d)),d}}async makeRequestWithTokens(t,i){const[a,l]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(t,i,a,l).getPromise()}}const Y1="@firebase/storage",Q1="0.14.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hE="storage";function q4(r=Nh(),t){r=fs(r);const a=Dh(r,hE).getImmediate({identifier:t}),l=p2("storage");return l&&H4(a,...l),a}function H4(r,t,i,a={}){B4(r,t,i,a)}function F4(r,{instanceIdentifier:t}){const i=r.getProvider("app").getImmediate(),a=r.getProvider("auth-internal"),l=r.getProvider("app-check-internal");return new j4(i,a,l,t,na)}function G4(){Js(new ss(hE,F4,"PUBLIC").setMultipleInstances(!0)),xi(Y1,Q1,""),xi(Y1,Q1,"esm2020")}G4();const K4={apiKey:"AIzaSyDkCmnE3tlZQ4-Yb-NCGFcN8_xFgjvj-7w",authDomain:"capstone-119c2.firebaseapp.com",projectId:"capstone-119c2",storageBucket:"capstone-119c2.appspot.com",messagingSenderId:"69255526866",appId:"1:69255526866:web:1ed76f51f53ab138c1300b"},Gh=nb().length?Nh():E2(K4),Y4=lC(Gh);m4(Gh);q4(Gh);var mn=function(){return mn=Object.assign||function(t){for(var i,a=1,l=arguments.length;a<l;a++){i=arguments[a];for(var c in i)Object.prototype.hasOwnProperty.call(i,c)&&(t[c]=i[c])}return t},mn.apply(this,arguments)};function Zl(r,t,i){if(i||arguments.length===2)for(var a=0,l=t.length,c;a<l;a++)(c||!(a in t))&&(c||(c=Array.prototype.slice.call(t,0,a)),c[a]=t[a]);return r.concat(c||Array.prototype.slice.call(t))}var ae="-ms-",ql="-moz-",Yt="-webkit-",fE="comm",Kh="rule",Pm="decl",Q4="@import",dE="@keyframes",X4="@layer",pE=Math.abs,zm=String.fromCharCode,Xp=Object.assign;function $4(r,t){return je(r,0)^45?(((t<<2^je(r,0))<<2^je(r,1))<<2^je(r,2))<<2^je(r,3):0}function mE(r){return r.trim()}function ar(r,t){return(r=t.exec(r))?r[0]:r}function Dt(r,t,i){return r.replace(t,i)}function rh(r,t,i){return r.indexOf(t,i)}function je(r,t){return r.charCodeAt(t)|0}function go(r,t,i){return r.slice(t,i)}function Di(r){return r.length}function gE(r){return r.length}function Ul(r,t){return t.push(r),r}function Z4(r,t){return r.map(t).join("")}function X1(r,t){return r.filter(function(i){return!ar(i,t)})}var Yh=1,yo=1,yE=0,jn=0,Oe=0,wo="";function Qh(r,t,i,a,l,c,d,g){return{value:r,root:t,parent:i,type:a,props:l,children:c,line:Yh,column:yo,length:d,return:"",siblings:g}}function Yr(r,t){return Xp(Qh("",null,null,"",null,null,0,r.siblings),r,{length:-r.length},t)}function Ka(r){for(;r.root;)r=Yr(r.root,{children:[r]});Ul(r,r.siblings)}function J4(){return Oe}function W4(){return Oe=jn>0?je(wo,--jn):0,yo--,Oe===10&&(yo=1,Yh--),Oe}function si(){return Oe=jn<yE?je(wo,jn++):0,yo++,Oe===10&&(yo=1,Yh++),Oe}function Xs(){return je(wo,jn)}function sh(){return jn}function Xh(r,t){return go(wo,r,t)}function $p(r){switch(r){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function tI(r){return Yh=yo=1,yE=Di(wo=r),jn=0,[]}function eI(r){return wo="",r}function yp(r){return mE(Xh(jn-1,Zp(r===91?r+2:r===40?r+1:r)))}function nI(r){for(;(Oe=Xs())&&Oe<33;)si();return $p(r)>2||$p(Oe)>3?"":" "}function iI(r,t){for(;--t&&si()&&!(Oe<48||Oe>102||Oe>57&&Oe<65||Oe>70&&Oe<97););return Xh(r,sh()+(t<6&&Xs()==32&&si()==32))}function Zp(r){for(;si();)switch(Oe){case r:return jn;case 34:case 39:r!==34&&r!==39&&Zp(Oe);break;case 40:r===41&&Zp(r);break;case 92:si();break}return jn}function rI(r,t){for(;si()&&r+Oe!==57;)if(r+Oe===84&&Xs()===47)break;return"/*"+Xh(t,jn-1)+"*"+zm(r===47?r:si())}function sI(r){for(;!$p(Xs());)si();return Xh(r,jn)}function aI(r){return eI(ah("",null,null,null,[""],r=tI(r),0,[0],r))}function ah(r,t,i,a,l,c,d,g,y){for(var v=0,S=0,b=d,x=0,q=0,$=0,Z=1,X=1,rt=1,ct=0,nt="",lt=l,yt=c,at=a,A=nt;X;)switch($=ct,ct=si()){case 40:if($!=108&&je(A,b-1)==58){rh(A+=Dt(yp(ct),"&","&\f"),"&\f",pE(v?g[v-1]:0))!=-1&&(rt=-1);break}case 34:case 39:case 91:A+=yp(ct);break;case 9:case 10:case 13:case 32:A+=nI($);break;case 92:A+=iI(sh()-1,7);continue;case 47:switch(Xs()){case 42:case 47:Ul(oI(rI(si(),sh()),t,i,y),y);break;default:A+="/"}break;case 123*Z:g[v++]=Di(A)*rt;case 125*Z:case 59:case 0:switch(ct){case 0:case 125:X=0;case 59+S:rt==-1&&(A=Dt(A,/\f/g,"")),q>0&&Di(A)-b&&Ul(q>32?Z1(A+";",a,i,b-1,y):Z1(Dt(A," ","")+";",a,i,b-2,y),y);break;case 59:A+=";";default:if(Ul(at=$1(A,t,i,v,S,l,g,nt,lt=[],yt=[],b,c),c),ct===123)if(S===0)ah(A,t,at,at,lt,c,b,g,yt);else switch(x===99&&je(A,3)===110?100:x){case 100:case 108:case 109:case 115:ah(r,at,at,a&&Ul($1(r,at,at,0,0,l,g,nt,l,lt=[],b,yt),yt),l,yt,b,g,a?lt:yt);break;default:ah(A,at,at,at,[""],yt,0,g,yt)}}v=S=q=0,Z=rt=1,nt=A="",b=d;break;case 58:b=1+Di(A),q=$;default:if(Z<1){if(ct==123)--Z;else if(ct==125&&Z++==0&&W4()==125)continue}switch(A+=zm(ct),ct*Z){case 38:rt=S>0?1:(A+="\f",-1);break;case 44:g[v++]=(Di(A)-1)*rt,rt=1;break;case 64:Xs()===45&&(A+=yp(si())),x=Xs(),S=b=Di(nt=A+=sI(sh())),ct++;break;case 45:$===45&&Di(A)==2&&(Z=0)}}return c}function $1(r,t,i,a,l,c,d,g,y,v,S,b){for(var x=l-1,q=l===0?c:[""],$=gE(q),Z=0,X=0,rt=0;Z<a;++Z)for(var ct=0,nt=go(r,x+1,x=pE(X=d[Z])),lt=r;ct<$;++ct)(lt=mE(X>0?q[ct]+" "+nt:Dt(nt,/&\f/g,q[ct])))&&(y[rt++]=lt);return Qh(r,t,i,l===0?Kh:g,y,v,S,b)}function oI(r,t,i,a){return Qh(r,t,i,fE,zm(J4()),go(r,2,-2),0,a)}function Z1(r,t,i,a,l){return Qh(r,t,i,Pm,go(r,0,a),go(r,a+1,-1),a,l)}function _E(r,t,i){switch($4(r,t)){case 5103:return Yt+"print-"+r+r;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return Yt+r+r;case 4789:return ql+r+r;case 5349:case 4246:case 4810:case 6968:case 2756:return Yt+r+ql+r+ae+r+r;case 5936:switch(je(r,t+11)){case 114:return Yt+r+ae+Dt(r,/[svh]\w+-[tblr]{2}/,"tb")+r;case 108:return Yt+r+ae+Dt(r,/[svh]\w+-[tblr]{2}/,"tb-rl")+r;case 45:return Yt+r+ae+Dt(r,/[svh]\w+-[tblr]{2}/,"lr")+r}case 6828:case 4268:case 2903:return Yt+r+ae+r+r;case 6165:return Yt+r+ae+"flex-"+r+r;case 5187:return Yt+r+Dt(r,/(\w+).+(:[^]+)/,Yt+"box-$1$2"+ae+"flex-$1$2")+r;case 5443:return Yt+r+ae+"flex-item-"+Dt(r,/flex-|-self/g,"")+(ar(r,/flex-|baseline/)?"":ae+"grid-row-"+Dt(r,/flex-|-self/g,""))+r;case 4675:return Yt+r+ae+"flex-line-pack"+Dt(r,/align-content|flex-|-self/g,"")+r;case 5548:return Yt+r+ae+Dt(r,"shrink","negative")+r;case 5292:return Yt+r+ae+Dt(r,"basis","preferred-size")+r;case 6060:return Yt+"box-"+Dt(r,"-grow","")+Yt+r+ae+Dt(r,"grow","positive")+r;case 4554:return Yt+Dt(r,/([^-])(transform)/g,"$1"+Yt+"$2")+r;case 6187:return Dt(Dt(Dt(r,/(zoom-|grab)/,Yt+"$1"),/(image-set)/,Yt+"$1"),r,"")+r;case 5495:case 3959:return Dt(r,/(image-set\([^]*)/,Yt+"$1$`$1");case 4968:return Dt(Dt(r,/(.+:)(flex-)?(.*)/,Yt+"box-pack:$3"+ae+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+Yt+r+r;case 4200:if(!ar(r,/flex-|baseline/))return ae+"grid-column-align"+go(r,t)+r;break;case 2592:case 3360:return ae+Dt(r,"template-","")+r;case 4384:case 3616:return i&&i.some(function(a,l){return t=l,ar(a.props,/grid-\w+-end/)})?~rh(r+(i=i[t].value),"span",0)?r:ae+Dt(r,"-start","")+r+ae+"grid-row-span:"+(~rh(i,"span",0)?ar(i,/\d+/):+ar(i,/\d+/)-+ar(r,/\d+/))+";":ae+Dt(r,"-start","")+r;case 4896:case 4128:return i&&i.some(function(a){return ar(a.props,/grid-\w+-start/)})?r:ae+Dt(Dt(r,"-end","-span"),"span ","")+r;case 4095:case 3583:case 4068:case 2532:return Dt(r,/(.+)-inline(.+)/,Yt+"$1$2")+r;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(Di(r)-1-t>6)switch(je(r,t+1)){case 109:if(je(r,t+4)!==45)break;case 102:return Dt(r,/(.+:)(.+)-([^]+)/,"$1"+Yt+"$2-$3$1"+ql+(je(r,t+3)==108?"$3":"$2-$3"))+r;case 115:return~rh(r,"stretch",0)?_E(Dt(r,"stretch","fill-available"),t,i)+r:r}break;case 5152:case 5920:return Dt(r,/(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/,function(a,l,c,d,g,y,v){return ae+l+":"+c+v+(d?ae+l+"-span:"+(g?y:+y-+c)+v:"")+r});case 4949:if(je(r,t+6)===121)return Dt(r,":",":"+Yt)+r;break;case 6444:switch(je(r,je(r,14)===45?18:11)){case 120:return Dt(r,/(.+:)([^;\s!]+)(;|(\s+)?!.+)?/,"$1"+Yt+(je(r,14)===45?"inline-":"")+"box$3$1"+Yt+"$2$3$1"+ae+"$2box$3")+r;case 100:return Dt(r,":",":"+ae)+r}break;case 5719:case 2647:case 2135:case 3927:case 2391:return Dt(r,"scroll-","scroll-snap-")+r}return r}function wh(r,t){for(var i="",a=0;a<r.length;a++)i+=t(r[a],a,r,t)||"";return i}function lI(r,t,i,a){switch(r.type){case X4:if(r.children.length)break;case Q4:case Pm:return r.return=r.return||r.value;case fE:return"";case dE:return r.return=r.value+"{"+wh(r.children,a)+"}";case Kh:if(!Di(r.value=r.props.join(",")))return""}return Di(i=wh(r.children,a))?r.return=r.value+"{"+i+"}":""}function uI(r){var t=gE(r);return function(i,a,l,c){for(var d="",g=0;g<t;g++)d+=r[g](i,a,l,c)||"";return d}}function cI(r){return function(t){t.root||(t=t.return)&&r(t)}}function hI(r,t,i,a){if(r.length>-1&&!r.return)switch(r.type){case Pm:r.return=_E(r.value,r.length,i);return;case dE:return wh([Yr(r,{value:Dt(r.value,"@","@"+Yt)})],a);case Kh:if(r.length)return Z4(i=r.props,function(l){switch(ar(l,a=/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":Ka(Yr(r,{props:[Dt(l,/:(read-\w+)/,":"+ql+"$1")]})),Ka(Yr(r,{props:[l]})),Xp(r,{props:X1(i,a)});break;case"::placeholder":Ka(Yr(r,{props:[Dt(l,/:(plac\w+)/,":"+Yt+"input-$1")]})),Ka(Yr(r,{props:[Dt(l,/:(plac\w+)/,":"+ql+"$1")]})),Ka(Yr(r,{props:[Dt(l,/:(plac\w+)/,ae+"input-$1")]})),Ka(Yr(r,{props:[l]})),Xp(r,{props:X1(i,a)});break}return""})}}var fI={animationIterationCount:1,aspectRatio:1,borderImageOutset:1,borderImageSlice:1,borderImageWidth:1,boxFlex:1,boxFlexGroup:1,boxOrdinalGroup:1,columnCount:1,columns:1,flex:1,flexGrow:1,flexPositive:1,flexShrink:1,flexNegative:1,flexOrder:1,gridRow:1,gridRowEnd:1,gridRowSpan:1,gridRowStart:1,gridColumn:1,gridColumnEnd:1,gridColumnSpan:1,gridColumnStart:1,msGridRow:1,msGridRowSpan:1,msGridColumn:1,msGridColumnSpan:1,fontWeight:1,lineHeight:1,opacity:1,order:1,orphans:1,tabSize:1,widows:1,zIndex:1,zoom:1,WebkitLineClamp:1,fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1},wn={},_o=typeof process<"u"&&wn!==void 0&&(wn.REACT_APP_SC_ATTR||wn.SC_ATTR)||"data-styled",vE="active",EE="data-styled-version",$h="6.1.19",Bm=`/*!sc*/
`,Rh=typeof window<"u"&&typeof document<"u",dI=!!(typeof SC_DISABLE_SPEEDY=="boolean"?SC_DISABLE_SPEEDY:typeof process<"u"&&wn!==void 0&&wn.REACT_APP_SC_DISABLE_SPEEDY!==void 0&&wn.REACT_APP_SC_DISABLE_SPEEDY!==""?wn.REACT_APP_SC_DISABLE_SPEEDY!=="false"&&wn.REACT_APP_SC_DISABLE_SPEEDY:typeof process<"u"&&wn!==void 0&&wn.SC_DISABLE_SPEEDY!==void 0&&wn.SC_DISABLE_SPEEDY!==""&&wn.SC_DISABLE_SPEEDY!=="false"&&wn.SC_DISABLE_SPEEDY),Zh=Object.freeze([]),vo=Object.freeze({});function pI(r,t,i){return i===void 0&&(i=vo),r.theme!==i.theme&&r.theme||t||i.theme}var TE=new Set(["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","tr","track","u","ul","use","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","marker","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"]),mI=/[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,gI=/(^-|-$)/g;function J1(r){return r.replace(mI,"-").replace(gI,"")}var yI=/(a)(d)/gi,Yc=52,W1=function(r){return String.fromCharCode(r+(r>25?39:97))};function Jp(r){var t,i="";for(t=Math.abs(r);t>Yc;t=t/Yc|0)i=W1(t%Yc)+i;return(W1(t%Yc)+i).replace(yI,"$1-$2")}var _p,SE=5381,Ja=function(r,t){for(var i=t.length;i;)r=33*r^t.charCodeAt(--i);return r},AE=function(r){return Ja(SE,r)};function bE(r){return Jp(AE(r)>>>0)}function _I(r){return r.displayName||r.name||"Component"}function vp(r){return typeof r=="string"&&!0}var wE=typeof Symbol=="function"&&Symbol.for,RE=wE?Symbol.for("react.memo"):60115,vI=wE?Symbol.for("react.forward_ref"):60112,EI={childContextTypes:!0,contextType:!0,contextTypes:!0,defaultProps:!0,displayName:!0,getDefaultProps:!0,getDerivedStateFromError:!0,getDerivedStateFromProps:!0,mixins:!0,propTypes:!0,type:!0},TI={name:!0,length:!0,prototype:!0,caller:!0,callee:!0,arguments:!0,arity:!0},CE={$$typeof:!0,compare:!0,defaultProps:!0,displayName:!0,propTypes:!0,type:!0},SI=((_p={})[vI]={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},_p[RE]=CE,_p);function t2(r){return("type"in(t=r)&&t.type.$$typeof)===RE?CE:"$$typeof"in r?SI[r.$$typeof]:EI;var t}var AI=Object.defineProperty,bI=Object.getOwnPropertyNames,e2=Object.getOwnPropertySymbols,wI=Object.getOwnPropertyDescriptor,RI=Object.getPrototypeOf,n2=Object.prototype;function IE(r,t,i){if(typeof t!="string"){if(n2){var a=RI(t);a&&a!==n2&&IE(r,a,i)}var l=bI(t);e2&&(l=l.concat(e2(t)));for(var c=t2(r),d=t2(t),g=0;g<l.length;++g){var y=l[g];if(!(y in TI||i&&i[y]||d&&y in d||c&&y in c)){var v=wI(t,y);try{AI(r,y,v)}catch{}}}}return r}function Eo(r){return typeof r=="function"}function jm(r){return typeof r=="object"&&"styledComponentId"in r}function Gs(r,t){return r&&t?"".concat(r," ").concat(t):r||t||""}function Wp(r,t){if(r.length===0)return"";for(var i=r[0],a=1;a<r.length;a++)i+=r[a];return i}function Jl(r){return r!==null&&typeof r=="object"&&r.constructor.name===Object.name&&!("props"in r&&r.$$typeof)}function tm(r,t,i){if(i===void 0&&(i=!1),!i&&!Jl(r)&&!Array.isArray(r))return t;if(Array.isArray(t))for(var a=0;a<t.length;a++)r[a]=tm(r[a],t[a]);else if(Jl(t))for(var a in t)r[a]=tm(r[a],t[a]);return r}function qm(r,t){Object.defineProperty(r,"toString",{value:t})}function uu(r){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];return new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(r," for more information.").concat(t.length>0?" Args: ".concat(t.join(", ")):""))}var CI=(function(){function r(t){this.groupSizes=new Uint32Array(512),this.length=512,this.tag=t}return r.prototype.indexOfGroup=function(t){for(var i=0,a=0;a<t;a++)i+=this.groupSizes[a];return i},r.prototype.insertRules=function(t,i){if(t>=this.groupSizes.length){for(var a=this.groupSizes,l=a.length,c=l;t>=c;)if((c<<=1)<0)throw uu(16,"".concat(t));this.groupSizes=new Uint32Array(c),this.groupSizes.set(a),this.length=c;for(var d=l;d<c;d++)this.groupSizes[d]=0}for(var g=this.indexOfGroup(t+1),y=(d=0,i.length);d<y;d++)this.tag.insertRule(g,i[d])&&(this.groupSizes[t]++,g++)},r.prototype.clearGroup=function(t){if(t<this.length){var i=this.groupSizes[t],a=this.indexOfGroup(t),l=a+i;this.groupSizes[t]=0;for(var c=a;c<l;c++)this.tag.deleteRule(a)}},r.prototype.getGroup=function(t){var i="";if(t>=this.length||this.groupSizes[t]===0)return i;for(var a=this.groupSizes[t],l=this.indexOfGroup(t),c=l+a,d=l;d<c;d++)i+="".concat(this.tag.getRule(d)).concat(Bm);return i},r})(),oh=new Map,Ch=new Map,lh=1,Qc=function(r){if(oh.has(r))return oh.get(r);for(;Ch.has(lh);)lh++;var t=lh++;return oh.set(r,t),Ch.set(t,r),t},II=function(r,t){lh=t+1,oh.set(r,t),Ch.set(t,r)},DI="style[".concat(_o,"][").concat(EE,'="').concat($h,'"]'),NI=new RegExp("^".concat(_o,'\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')),OI=function(r,t,i){for(var a,l=i.split(","),c=0,d=l.length;c<d;c++)(a=l[c])&&r.registerName(t,a)},xI=function(r,t){for(var i,a=((i=t.textContent)!==null&&i!==void 0?i:"").split(Bm),l=[],c=0,d=a.length;c<d;c++){var g=a[c].trim();if(g){var y=g.match(NI);if(y){var v=0|parseInt(y[1],10),S=y[2];v!==0&&(II(S,v),OI(r,S,y[3]),r.getTag().insertRules(v,l)),l.length=0}else l.push(g)}}},i2=function(r){for(var t=document.querySelectorAll(DI),i=0,a=t.length;i<a;i++){var l=t[i];l&&l.getAttribute(_o)!==vE&&(xI(r,l),l.parentNode&&l.parentNode.removeChild(l))}};function MI(){return typeof __webpack_nonce__<"u"?__webpack_nonce__:null}var DE=function(r){var t=document.head,i=r||t,a=document.createElement("style"),l=(function(g){var y=Array.from(g.querySelectorAll("style[".concat(_o,"]")));return y[y.length-1]})(i),c=l!==void 0?l.nextSibling:null;a.setAttribute(_o,vE),a.setAttribute(EE,$h);var d=MI();return d&&a.setAttribute("nonce",d),i.insertBefore(a,c),a},VI=(function(){function r(t){this.element=DE(t),this.element.appendChild(document.createTextNode("")),this.sheet=(function(i){if(i.sheet)return i.sheet;for(var a=document.styleSheets,l=0,c=a.length;l<c;l++){var d=a[l];if(d.ownerNode===i)return d}throw uu(17)})(this.element),this.length=0}return r.prototype.insertRule=function(t,i){try{return this.sheet.insertRule(i,t),this.length++,!0}catch{return!1}},r.prototype.deleteRule=function(t){this.sheet.deleteRule(t),this.length--},r.prototype.getRule=function(t){var i=this.sheet.cssRules[t];return i&&i.cssText?i.cssText:""},r})(),UI=(function(){function r(t){this.element=DE(t),this.nodes=this.element.childNodes,this.length=0}return r.prototype.insertRule=function(t,i){if(t<=this.length&&t>=0){var a=document.createTextNode(i);return this.element.insertBefore(a,this.nodes[t]||null),this.length++,!0}return!1},r.prototype.deleteRule=function(t){this.element.removeChild(this.nodes[t]),this.length--},r.prototype.getRule=function(t){return t<this.length?this.nodes[t].textContent:""},r})(),LI=(function(){function r(t){this.rules=[],this.length=0}return r.prototype.insertRule=function(t,i){return t<=this.length&&(this.rules.splice(t,0,i),this.length++,!0)},r.prototype.deleteRule=function(t){this.rules.splice(t,1),this.length--},r.prototype.getRule=function(t){return t<this.length?this.rules[t]:""},r})(),r2=Rh,kI={isServer:!Rh,useCSSOMInjection:!dI},NE=(function(){function r(t,i,a){t===void 0&&(t=vo),i===void 0&&(i={});var l=this;this.options=mn(mn({},kI),t),this.gs=i,this.names=new Map(a),this.server=!!t.isServer,!this.server&&Rh&&r2&&(r2=!1,i2(this)),qm(this,function(){return(function(c){for(var d=c.getTag(),g=d.length,y="",v=function(b){var x=(function(rt){return Ch.get(rt)})(b);if(x===void 0)return"continue";var q=c.names.get(x),$=d.getGroup(b);if(q===void 0||!q.size||$.length===0)return"continue";var Z="".concat(_o,".g").concat(b,'[id="').concat(x,'"]'),X="";q!==void 0&&q.forEach(function(rt){rt.length>0&&(X+="".concat(rt,","))}),y+="".concat($).concat(Z,'{content:"').concat(X,'"}').concat(Bm)},S=0;S<g;S++)v(S);return y})(l)})}return r.registerId=function(t){return Qc(t)},r.prototype.rehydrate=function(){!this.server&&Rh&&i2(this)},r.prototype.reconstructWithOptions=function(t,i){return i===void 0&&(i=!0),new r(mn(mn({},this.options),t),this.gs,i&&this.names||void 0)},r.prototype.allocateGSInstance=function(t){return this.gs[t]=(this.gs[t]||0)+1},r.prototype.getTag=function(){return this.tag||(this.tag=(t=(function(i){var a=i.useCSSOMInjection,l=i.target;return i.isServer?new LI(l):a?new VI(l):new UI(l)})(this.options),new CI(t)));var t},r.prototype.hasNameForId=function(t,i){return this.names.has(t)&&this.names.get(t).has(i)},r.prototype.registerName=function(t,i){if(Qc(t),this.names.has(t))this.names.get(t).add(i);else{var a=new Set;a.add(i),this.names.set(t,a)}},r.prototype.insertRules=function(t,i,a){this.registerName(t,i),this.getTag().insertRules(Qc(t),a)},r.prototype.clearNames=function(t){this.names.has(t)&&this.names.get(t).clear()},r.prototype.clearRules=function(t){this.getTag().clearGroup(Qc(t)),this.clearNames(t)},r.prototype.clearTag=function(){this.tag=void 0},r})(),PI=/&/g,zI=/^\s*\/\/.*$/gm;function OE(r,t){return r.map(function(i){return i.type==="rule"&&(i.value="".concat(t," ").concat(i.value),i.value=i.value.replaceAll(",",",".concat(t," ")),i.props=i.props.map(function(a){return"".concat(t," ").concat(a)})),Array.isArray(i.children)&&i.type!=="@keyframes"&&(i.children=OE(i.children,t)),i})}function BI(r){var t,i,a,l=vo,c=l.options,d=c===void 0?vo:c,g=l.plugins,y=g===void 0?Zh:g,v=function(x,q,$){return $.startsWith(i)&&$.endsWith(i)&&$.replaceAll(i,"").length>0?".".concat(t):x},S=y.slice();S.push(function(x){x.type===Kh&&x.value.includes("&")&&(x.props[0]=x.props[0].replace(PI,i).replace(a,v))}),d.prefix&&S.push(hI),S.push(lI);var b=function(x,q,$,Z){q===void 0&&(q=""),$===void 0&&($=""),Z===void 0&&(Z="&"),t=Z,i=q,a=new RegExp("\\".concat(i,"\\b"),"g");var X=x.replace(zI,""),rt=aI($||q?"".concat($," ").concat(q," { ").concat(X," }"):X);d.namespace&&(rt=OE(rt,d.namespace));var ct=[];return wh(rt,uI(S.concat(cI(function(nt){return ct.push(nt)})))),ct};return b.hash=y.length?y.reduce(function(x,q){return q.name||uu(15),Ja(x,q.name)},SE).toString():"",b}var jI=new NE,em=BI(),xE=Hl.createContext({shouldForwardProp:void 0,styleSheet:jI,stylis:em});xE.Consumer;Hl.createContext(void 0);function s2(){return Bn.useContext(xE)}var ME=(function(){function r(t,i){var a=this;this.inject=function(l,c){c===void 0&&(c=em);var d=a.name+c.hash;l.hasNameForId(a.id,d)||l.insertRules(a.id,d,c(a.rules,d,"@keyframes"))},this.name=t,this.id="sc-keyframes-".concat(t),this.rules=i,qm(this,function(){throw uu(12,String(a.name))})}return r.prototype.getName=function(t){return t===void 0&&(t=em),this.name+t.hash},r})(),qI=function(r){return r>="A"&&r<="Z"};function a2(r){for(var t="",i=0;i<r.length;i++){var a=r[i];if(i===1&&a==="-"&&r[0]==="-")return r;qI(a)?t+="-"+a.toLowerCase():t+=a}return t.startsWith("ms-")?"-"+t:t}var VE=function(r){return r==null||r===!1||r===""},UE=function(r){var t,i,a=[];for(var l in r){var c=r[l];r.hasOwnProperty(l)&&!VE(c)&&(Array.isArray(c)&&c.isCss||Eo(c)?a.push("".concat(a2(l),":"),c,";"):Jl(c)?a.push.apply(a,Zl(Zl(["".concat(l," {")],UE(c),!1),["}"],!1)):a.push("".concat(a2(l),": ").concat((t=l,(i=c)==null||typeof i=="boolean"||i===""?"":typeof i!="number"||i===0||t in fI||t.startsWith("--")?String(i).trim():"".concat(i,"px")),";")))}return a};function $s(r,t,i,a){if(VE(r))return[];if(jm(r))return[".".concat(r.styledComponentId)];if(Eo(r)){if(!Eo(c=r)||c.prototype&&c.prototype.isReactComponent||!t)return[r];var l=r(t);return $s(l,t,i,a)}var c;return r instanceof ME?i?(r.inject(i,a),[r.getName(a)]):[r]:Jl(r)?UE(r):Array.isArray(r)?Array.prototype.concat.apply(Zh,r.map(function(d){return $s(d,t,i,a)})):[r.toString()]}function HI(r){for(var t=0;t<r.length;t+=1){var i=r[t];if(Eo(i)&&!jm(i))return!1}return!0}var FI=AE($h),GI=(function(){function r(t,i,a){this.rules=t,this.staticRulesId="",this.isStatic=(a===void 0||a.isStatic)&&HI(t),this.componentId=i,this.baseHash=Ja(FI,i),this.baseStyle=a,NE.registerId(i)}return r.prototype.generateAndInjectStyles=function(t,i,a){var l=this.baseStyle?this.baseStyle.generateAndInjectStyles(t,i,a):"";if(this.isStatic&&!a.hash)if(this.staticRulesId&&i.hasNameForId(this.componentId,this.staticRulesId))l=Gs(l,this.staticRulesId);else{var c=Wp($s(this.rules,t,i,a)),d=Jp(Ja(this.baseHash,c)>>>0);if(!i.hasNameForId(this.componentId,d)){var g=a(c,".".concat(d),void 0,this.componentId);i.insertRules(this.componentId,d,g)}l=Gs(l,d),this.staticRulesId=d}else{for(var y=Ja(this.baseHash,a.hash),v="",S=0;S<this.rules.length;S++){var b=this.rules[S];if(typeof b=="string")v+=b;else if(b){var x=Wp($s(b,t,i,a));y=Ja(y,x+S),v+=x}}if(v){var q=Jp(y>>>0);i.hasNameForId(this.componentId,q)||i.insertRules(this.componentId,q,a(v,".".concat(q),void 0,this.componentId)),l=Gs(l,q)}}return l},r})(),LE=Hl.createContext(void 0);LE.Consumer;var Ep={};function KI(r,t,i){var a=jm(r),l=r,c=!vp(r),d=t.attrs,g=d===void 0?Zh:d,y=t.componentId,v=y===void 0?(function(lt,yt){var at=typeof lt!="string"?"sc":J1(lt);Ep[at]=(Ep[at]||0)+1;var A="".concat(at,"-").concat(bE($h+at+Ep[at]));return yt?"".concat(yt,"-").concat(A):A})(t.displayName,t.parentComponentId):y,S=t.displayName,b=S===void 0?(function(lt){return vp(lt)?"styled.".concat(lt):"Styled(".concat(_I(lt),")")})(r):S,x=t.displayName&&t.componentId?"".concat(J1(t.displayName),"-").concat(t.componentId):t.componentId||v,q=a&&l.attrs?l.attrs.concat(g).filter(Boolean):g,$=t.shouldForwardProp;if(a&&l.shouldForwardProp){var Z=l.shouldForwardProp;if(t.shouldForwardProp){var X=t.shouldForwardProp;$=function(lt,yt){return Z(lt,yt)&&X(lt,yt)}}else $=Z}var rt=new GI(i,x,a?l.componentStyle:void 0);function ct(lt,yt){return(function(at,A,w){var C=at.attrs,M=at.componentStyle,O=at.defaultProps,U=at.foldedComponentIds,R=at.styledComponentId,ne=at.target,de=Hl.useContext(LE),H=s2(),tt=at.shouldForwardProp||H.shouldForwardProp,ft=pI(A,de,O)||vo,At=(function(mt,vt,Nt){for(var ie,qt=mn(mn({},vt),{className:void 0,theme:Nt}),qn=0;qn<mt.length;qn+=1){var Hn=Eo(ie=mt[qn])?ie(qt):ie;for(var en in Hn)qt[en]=en==="className"?Gs(qt[en],Hn[en]):en==="style"?mn(mn({},qt[en]),Hn[en]):Hn[en]}return vt.className&&(qt.className=Gs(qt.className,vt.className)),qt})(C,A,ft),Pt=At.as||ne,D={};for(var G in At)At[G]===void 0||G[0]==="$"||G==="as"||G==="theme"&&At.theme===ft||(G==="forwardedAs"?D.as=At.forwardedAs:tt&&!tt(G,Pt)||(D[G]=At[G]));var et=(function(mt,vt){var Nt=s2(),ie=mt.generateAndInjectStyles(vt,Nt.styleSheet,Nt.stylis);return ie})(M,At),it=Gs(U,R);return et&&(it+=" "+et),At.className&&(it+=" "+At.className),D[vp(Pt)&&!TE.has(Pt)?"class":"className"]=it,w&&(D.ref=w),Bn.createElement(Pt,D)})(nt,lt,yt)}ct.displayName=b;var nt=Hl.forwardRef(ct);return nt.attrs=q,nt.componentStyle=rt,nt.displayName=b,nt.shouldForwardProp=$,nt.foldedComponentIds=a?Gs(l.foldedComponentIds,l.styledComponentId):"",nt.styledComponentId=x,nt.target=a?l.target:r,Object.defineProperty(nt,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(lt){this._foldedDefaultProps=a?(function(yt){for(var at=[],A=1;A<arguments.length;A++)at[A-1]=arguments[A];for(var w=0,C=at;w<C.length;w++)tm(yt,C[w],!0);return yt})({},l.defaultProps,lt):lt}}),qm(nt,function(){return".".concat(nt.styledComponentId)}),c&&IE(nt,r,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0}),nt}function o2(r,t){for(var i=[r[0]],a=0,l=t.length;a<l;a+=1)i.push(t[a],r[a+1]);return i}var l2=function(r){return Object.assign(r,{isCss:!0})};function kE(r){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];if(Eo(r)||Jl(r))return l2($s(o2(Zh,Zl([r],t,!0))));var a=r;return t.length===0&&a.length===1&&typeof a[0]=="string"?$s(a):l2($s(o2(a,t)))}function nm(r,t,i){if(i===void 0&&(i=vo),!t)throw uu(1,t);var a=function(l){for(var c=[],d=1;d<arguments.length;d++)c[d-1]=arguments[d];return r(t,i,kE.apply(void 0,Zl([l],c,!1)))};return a.attrs=function(l){return nm(r,t,mn(mn({},i),{attrs:Array.prototype.concat(i.attrs,l).filter(Boolean)}))},a.withConfig=function(l){return nm(r,t,mn(mn({},i),l))},a}var PE=function(r){return nm(KI,r)},Ct=PE;TE.forEach(function(r){Ct[r]=PE(r)});function YI(r){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];var a=Wp(kE.apply(void 0,Zl([r],t,!1))),l=bE(a);return new ME(l,a)}const QI="/repo/assets/Coak-DECjXcFO.png",u2="data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20opacity='0.6'%3e%3cpath%20d='M23.7517%2027.4276H7.96473C7.26826%2027.4276%206.8042%2026.9636%206.8042%2026.2671V23.9453H24.9123V26.2671C24.9123%2026.8477%2024.4482%2027.4276%2023.7517%2027.4276Z'%20fill='white'/%3e%3cpath%20d='M15.858%208.28527C16.8836%208.28527%2017.715%207.45387%2017.715%206.42828C17.715%205.40269%2016.8836%204.57129%2015.858%204.57129C14.8324%204.57129%2014.001%205.40269%2014.001%206.42828C14.001%207.45387%2014.8324%208.28527%2015.858%208.28527Z'%20fill='white'/%3e%3cpath%20d='M27.9307%2012.8019C28.9563%2012.8019%2029.7877%2011.9705%2029.7877%2010.9449C29.7877%209.91929%2028.9563%209.08789%2027.9307%209.08789C26.9051%209.08789%2026.0737%209.91929%2026.0737%2010.9449C26.0737%2011.9705%2026.9051%2012.8019%2027.9307%2012.8019Z'%20fill='white'/%3e%3cpath%20d='M3.78619%2012.8019C4.81178%2012.8019%205.64319%2011.9705%205.64319%2010.9449C5.64319%209.91929%204.81178%209.08789%203.78619%209.08789C2.7606%209.08789%201.9292%209.91929%201.9292%2010.9449C1.9292%2011.9705%202.7606%2012.8019%203.78619%2012.8019Z'%20fill='white'/%3e%3cpath%20d='M24.9122%2023.9463L26.9679%2012.9085C27.0588%2012.4202%2026.539%2012.0463%2026.105%2012.289L22.4423%2014.3366C21.4196%2014.9084%2020.1286%2014.5778%2019.5062%2013.5851L16.3552%208.56105C16.125%208.19449%2015.5913%208.19449%2015.3619%208.56105L12.2109%2013.5851C11.5885%2014.5778%2010.2975%2014.9077%209.27478%2014.3366L5.61211%2012.289C5.1781%2012.0463%204.65832%2012.4195%204.74923%2012.9085L6.80489%2023.9463'%20fill='white'/%3e%3cpath%20d='M24.9122%2023.9463L26.9679%2012.9085C27.0588%2012.4202%2026.539%2012.0463%2026.105%2012.289L22.4423%2014.3366C21.4196%2014.9084%2020.1286%2014.5778%2019.5062%2013.5851L16.3552%208.56105C16.125%208.19449%2015.5913%208.19449%2015.3619%208.56105L12.2109%2013.5851C11.5885%2014.5778%2010.2975%2014.9077%209.27478%2014.3366L5.61211%2012.289C5.1781%2012.0463%204.65832%2012.4195%204.74923%2012.9085L6.80489%2023.9463'%20fill='white'/%3e%3c/g%3e%3c/svg%3e";function zE(r={}){const t=Number(r.distanceKm)||0,i=Number(r.areaKm2)||0,a=Number(r.gyroCombined)||0,l=t>=4?3:t>=2?2:1,c=i>=.7?3:i>=.2?2:1,d=a>=.02?3:a>=.01?2:1;return[{key:"distance",category:"거리",level:l},{key:"area",category:"면적",level:c},{key:"gyro",category:"자이로",level:d}]}function BE(r,t){return r==="distance"?`/Badge/Badge_Length_${t}.svg`:r==="area"?`/Badge/Badge_Width_${t}.svg`:r==="gyro"?`/Badge/Badge_Gyro_${t}.svg`:""}const jE="/repo/assets/Rank1-DcYBW496.svg",qE="/repo/assets/Rank2-CHwKJAFY.svg",HE="/repo/assets/Rank3-UZrXxSfg.svg",XI=Ct.div`
  position: relative;
  width: 280px;
...
`;function i6({ranking:r,user:t}){const i=Bn.useMemo(()=>zE(t),[t]),a=r===1?jE:r===2?qE:r===3?HE:null;return ut.jsxs(XI,{$ranking:r,children:[a&&ut.jsx(n6,{$ranking:r,src:a,alt:`Rank${r}`}),ut.jsxs($I,{children:[ut.jsx(ZI,{$ranking:r,children:(()=>{const l=t&&(t.nickname||t.userName||t.name)||"-";return l.length>6?l.slice(0,6)+"...":l})()}),ut.jsxs(JI,{children:[ut.jsx(WI,{$ranking:r,children:t&&typeof t.distanceKm=="number"?t.distanceKm.toFixed(2):t&&!isNaN(Number(t.distanceKm))?Number(t.distanceKm).toFixed(2):"-"}),ut.jsx(t6,{$ranking:r,children:"km"})]})]}),ut.jsx(e6,{children:i.map(l=>ut.jsx("img",{src:BE(l.key,l.level),alt:`${l.category} Lv.${l.level}`,style:{width:32,height:32}},l.key))})]})}const r6=Ct.div`
  width: 100%;
  max-width: 1024px;
  display: flex;
  justify-content: center;
...
`,T6=Ct.div`
  ...
  line-height: 100%; /* 16px */
  letter-spacing: -0.32px;
`;function S6({ranking:r,user:t,highlight:i,...a}){const l=Bn.useMemo(()=>zE(t),[t]),c=r===1?jE:r===2?qE:r===3?HE:null;return ut.jsxs(d6,{$ranking:r,$highlight:i,...a,children:[ut.jsx(p6,{$ranking:r,children:c?ut.jsx("img",{src:c,alt:`Rank${r}`,style:{width:40,height:40}}):ut.jsx(m6,{children:r})}),ut.jsx(g6,{$ranking:r,children:t&&(t.nickname||t.userName||t.name)||"-"}),ut.jsx(y6,{children:ut.jsx(_6,{children:l.map(d=>ut.jsx("img",{src:BE(d.key,d.level),alt:`${d.category} Lv.${d.level}`,style:{width:28,height:28}},d.key))})}),ut.jsxs(v6,{$ranking:r,children:[ut.jsx(E6,{$ranking:r,children:t&&!isNaN(Number(t.distanceKm))?Number(t.distanceKm).toFixed(2):"-"}),ut.jsx(T6,{$ranking:r,children:"km"})]})]})}const A6=Ct.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 20px;
...
`;function q6(){const[r,t]=Bn.useState([]);return Bn.useEffect(()=>{console.log("Firebase App Name:",Gh.name),(async()=>{try{const l=(await _C(oC(Y4,"userFields"))).docs.map(c=>({id:c.id,...c.data()}));t(l),console.log("userFields 컬렉션 데이터:",l)}catch(a){console.error("userFields 데이터 불러오기 오류:",a)}})()},[]),ut.jsxs(P6,{children:[ut.jsxs(z6,{children:[ut.jsxs(B6,{children:[ut.jsx("img",{src:U6}),ut.jsx("img",{src:L6}),ut.jsx("img",{src:k6}),ut.jsx("p",{children:"Ranking"})]}),ut.jsx(j6,{children:ut.jsx("img",{src:QI,alt:"Ranking Logo"})})]}),ut.jsx(h6,{userFields:r}),ut.jsx(V6,{userFields:r})]})}function H6(){return ut.jsx(ut.Fragment,{children:ut.jsx(q6,{})})}NS.createRoot(document.getElementById("root")).render(ut.jsx(Bn.StrictMode,{children:ut.jsx(H6,{})}));
